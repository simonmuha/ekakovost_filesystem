                ...
                @foreach ($school_organization_people as $school_organization_person)
                    <tr style="border-bottom: 1pt solid black;"">
                        ...
                        <td>
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="/school_admin/school/users/{{$school_organization_person->id}}" title="Prikaži">{{$school_organization_person->person_name}}</a>

                                </div>
                            </div>
                        </td>
                        <td style="text-align: center;">
                            <a href="/school_admin/school/users/{{$school_organization_person->id}}" title="Prikaži">{{$school_organization_person->person_email}}</a>
                        </td>
                    </tr>
                @endforeach
            </table>
