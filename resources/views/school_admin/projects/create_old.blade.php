...
@section('content')
                    ...
                    <!-- Start::row-1 -->
                    <form method="POST" action="{{ action('App\Http\Controllers\SchoolAdmin\ProjectsController@store') }}" enctype="multipart/form-data">
                        @csrf
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <div class="row gy-3">
                                                ...
                                                <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12">
                                                    ...
                                                    <textarea class="form-control" id="text-area" name="project_description_short" rows="3">
                                                        {{ old('project_description_short') }}
                                                    </textarea>
                                                </div>
                                                <div class="col-xl-12">
                                                    <label class="form-label">Opis projekta:</label>
                                                    <div id="project_description-editor"></div>
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" class="btn btn-primary-light float-end">Ustvari projekt</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        var quill = new Quill('#project_description-editor', {
            modules: {
                toolbar: [
                    [{ 'header': [1, 2, 3, false] }],
        ...
        // Ko uporabnik odda obrazec, prenesi podatke v skrito polje
