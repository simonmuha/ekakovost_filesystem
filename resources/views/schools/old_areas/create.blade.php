...
{!! Form::open(['action' => 'App\Http\Controllers\School\SchoolAreasController@store', 'method' =>'POST', 'enctype'=>'multipart/form-data']) !!}
    <div class="row">
        <div class="d-flex align-items-center justify-content-between bd-highlight" >
            <div class="bd-highlight">
                <h4>Dodaj Področje šole</h4>
            </div>
            <div class="bd-highlight">
                ...
                <div class="col-md-12">
                    <div class='form-group'>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                {{Form::text('school_area_name','',['class' =>'form-control', 'placeholder'=>'Ime'])}}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                {{Form::textarea('school_area_description', '', ['id' => 'description-ckeditor', 'class' => 'form-control', 'placeholder' => 'Opis področja','rows' => 5])}}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                {{Form::textarea('school_area_description_short', '', ['id' => 'description_short-ckeditor', 'class' => 'form-control', 'placeholder' => 'Kratek opis področja','rows' => 5])}}
                            </div>
                        </div>
                    </div>
