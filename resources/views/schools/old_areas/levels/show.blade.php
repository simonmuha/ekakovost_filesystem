    ...
    <div class="col-md-12">
        <div class="card material-card">
            <div class="card-header qaq-card-header">
                ...
                <h3 class="card-title"><a href="/schools/areas/{{ $school_area->id }}" class="material-link">Stopnja {!!$school_area_level->school_area_level_number!!} - {!!$school_area_level->school_area_level_name!!}</a> </h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8">
                    ...
                    <div class="col-md-4">
                        <img style= "width:100%" src="/storage/schools/areas/levels/{{$school_area_level->school_area_level_image}}">
                    </div>
                </div>
            </div>
        ...
        <div class="card material-card">
            <div class="card-header qaq-card-header">
                <div class="row"> 
                    <div class="d-flex align-items-center justify-content-between bd-highlight" >
                        <div class="bd-highlight">
                            <h4><a href="/schools/areas/{{ $school_area->id }}" class="material-link">Odsek A: Kaj morate vedeti!</a></h4>
                        </div>
                        <div class="bd-highlight">
                            <a href="/schools/areas/levels/knows/create_know_add_to_level/{{ $school_area_level->id }}" title="Dodaj novo področje"><i class="fa fa-plus fa-lg icon-menu"> </i></a>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="content-box">
                                            <div class="row"> 
                                                <div class="d-flex align-items-center justify-content-between bd-highlight" >
                                                    ...
                                                    <div class="bd-highlight">
                                                        <a href="/schools/areas/levels/knows/{{$school_area->id}}/edit" title="Uredi"><i class="fa fa-pencil-square-o fa-lg icon-menu"> </i></a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="content-box">
                                            <div class="row"> 
                                                <div class="d-flex align-items-center justify-content-between bd-highlight" >
                                                    ...
                                                    <div class="bd-highlight">
                                                        <a href="/schools/areas/levels/knows/{{$school_area_level_know->id}}/edit" title="Uredi"><i class="fa fa-pencil-square-o fa-lg icon-menu"> </i></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <i>{{ strtoupper($school_area_level_know->type->school_area_level_know_type_name) }}</i><br>
        ...
        <div class="card material-card">
            <div class="card-header qaq-card-header">
                <div class="row">
                    <div class="d-flex align-items-center justify-content-between bd-highlight" >
                        <div class="bd-highlight">
                        <h3 class="card-title"><a href="/schools/areas/{{ $school_area->id }}" class="material-link">Odsek B: Kaj morate narediti!</a> </h3>
                        </div>
                        <div class="bd-highlight">
                            <a href="/schools/areas/levels/dos/create_do_add_to_level/{{ $school_area_level->id }}" title="Dodajte"><i class="fa fa-plus fa-lg icon-menu"> </i></a>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="content-box">
                                        <div class="row"> 
                                            <div class="d-flex align-items-center justify-content-between bd-highlight" >
                                                ...
                                                <div class="bd-highlight">
                                                    <a href="/schools/areas/levels/dos/{{$school_area_level_do->id}}/edit" title="Uredi"><i class="fa fa-pencil-square-o fa-lg icon-menu"> </i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
        ...
        <div class="card material-card">
            <div class="card-header qaq-card-header">
                <div class="row">
                    <div class="d-flex align-items-center justify-content-between bd-highlight" >
                        <div class="bd-highlight">
                            <h3 class="card-title"><a href="/schools/areas/{{ $school_area->id }}" class="material-link">Odsek C: Napotki</a> </h3>
                        </div>
                        <div class="bd-highlight">
                            <a href="/schools/areas/levels/guides/create_guide_add_to_level/{{ $school_area_level->id }}" title="Dodajte"><i class="fa fa-plus fa-lg icon-menu"> </i></a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="content-box">
                                    <div class="row"> 
                                        <div class="d-flex align-items-center justify-content-between bd-highlight" >
                                            ...
                                            <div class="bd-highlight">
                                            <a href="/schools/areas/levels/guides/{{$school_area_level_example->id}}/edit" title="Uredi"><i class="fa fa-pencil-square-o fa-lg icon-menu"> </i></a>
                                            </div>
                                        </div>
                                    </div>
