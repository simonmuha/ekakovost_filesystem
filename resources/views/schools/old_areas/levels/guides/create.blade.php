...
{!! Form::open(['action' => 'App\Http\Controllers\School\SchoolAreaLevelGuidesController@store', 'method' =>'POST', 'enctype'=>'multipart/form-data']) !!}
                ...
                <div class="card-body">
                    ...
                    <div class='form-group'>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                {{Form::text('school_area_level_guide_title','',['class' =>'form-control', 'placeholder'=>'Naslov'])}}
                            </div>
                        </div>
                    </div>
                    <div class='form-group'>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                {!! Form::select('school_area_level_guide_type_id', $school_area_level_guide_types, null, ['class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
                    <div class='form-group'>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                {{Form::textarea('school_area_level_guide_description', '', ['id' => 'description-ckeditor', 'class' => 'form-control', 'placeholder' => 'Kratek opis','rows' => 5])}}
                            </div>
                        </div>
                    </div>
                </div>
