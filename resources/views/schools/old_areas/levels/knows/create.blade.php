...
{!! Form::open(['action' => 'App\Http\Controllers\School\SchoolAreaLevelKnowsController@store', 'method' =>'POST', 'enctype'=>'multipart/form-data']) !!}
                ...
                <div class="card-body">
                    ...
                    <div class='form-group'>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                {{Form::text('school_area_level_know_title','',['class' =>'form-control', 'placeholder'=>'Naslov'])}}
                            </div>
                        </div>
                    </div>
                    <div class='form-group'>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                {!! Form::select('school_area_level_know_type_id', $school_area_level_know_types, null, ['class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
                    <div class='form-group'>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                {{Form::textarea('school_area_level_know_description_short', '', ['id' => 'description_short-ckeditor', 'class' => 'form-control', 'placeholder' => 'Kratek opis','rows' => 5])}}
                            </div>
                        </div>
                    </div>
                    <div class='form-group'>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                {{Form::textarea('school_area_level_know_description', '', ['id' => 'description-ckeditor', 'class' => 'form-control', 'placeholder' => 'Dolg opis','rows' => 5])}}
                            </div>
                        </div>
                    </div>
