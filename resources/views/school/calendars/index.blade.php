                            ...
                            <div class="card custom-card overflow-hidden main-content-card">
                                <div class="card-body">
                                    <div class="d-flex align-items-start justify-content-between mb-2">
                                        <div>
                                            <span class="text-muted d-block mb-1">Tedenski dogodki</span>
                                            <h4 class="fw-medium mb-0">{{ $weekly_events->count() }}</h4>
                                        </div>
                                        <div class="lh-1">
                                    ...
                                    <div class="text-muted fs-13">
                                        <a href="/school/calendars/school/week" title="Dogodki po tednu">
                                            Poglej tedenske dogodke
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xxl-3">
                            <div class="card custom-card overflow-hidden main-content-card">
                                <div class="card-body">
                                    <div class="d-flex align-items-start justify-content-between mb-2">
                                        <div>
                                            <span class="text-muted d-block mb-1">Današnji dogodki</span>
                                            <h4 class="fw-medium mb-0">{{ $today_events->count() }}</h4>
                                        </div>
                                        <div class="lh-1">
                                    ...
                                    <div class="text-muted fs-13">
                                    <a href="/school/calendars/school/day" title="Dnevni dogodki">
                                            Poglej dnevne dogodke
                                        </a> 
                                    </div>
                                </div>
                            </div>
