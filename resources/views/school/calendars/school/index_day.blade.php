        ...
        <div>
            <nav>
                <ol class="breadcrumb mb-1">
                    ...
                    <li class="breadcrumb-item"><a href="/school/calendars/school/day">Današnji dogodki</a></li>
                </ol>
            </nav>
        </div>
        <div class="btn-list">
        ...
        <div class="col-xl-3">
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    <div class="card-title">Vsi dogodki</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            initialView: 'listDay',  // Privzeti pogled: seznam današnjih dogodkov
            initialDate: '{{ \Carbon\Carbon::today()->format('Y-m-d') }}',  // Nastavi današnji datum
            ...
            headerToolbar: {
                left: '',                // Brez gumbov na levi
                center: 'title',         // Prikaz samo današnjega datuma na sredini
                right: ''                // Brez gumbov na desni
            },
            buttonText: {
                today: 'Danes',
                list: 'Seznam'  // Prilagodi besedilo za seznam
            },
            noEventsText: 'Ni dogodkov za današnji dan',
