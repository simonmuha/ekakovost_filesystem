                        ...
                        <div>
                            <nav>
                                <ol class="breadcrumb mb-1">
                                    ...
                                    <li class="breadcrumb-item"><a href="/school/calendars/school/week">Tedenski dogodki</a></li>
                                </ol>
                            </nav>
                        </div>
                        <div class="btn-list">
                                                    ...
                                                    <li>
                                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                            <p class="mb-1 fw-medium">
                                                                <a href="{{ url('/school/calendars/events/' . $event->id) }}">
                                                                    {{ e($event->calendar_event_title) }}
                                                                </a>
                                                            </p>
