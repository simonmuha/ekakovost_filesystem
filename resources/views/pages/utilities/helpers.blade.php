                    ...
                    <div class="row">
                        <div class="col-xxl-4 col-lg-6 col-md-6 col-sm-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <span class="badge text-bg-primary1">Primary1</span>
                                    <span class="badge text-bg-info mb-4">Info</span>
                                    <h6 class="fw-medium mb-3">cards:</h6>
                                    <div class="card text-bg-success mb-3 text-fixed-white" style="max-width: 31rem;">
                                    ...
                                    <div class="card text-bg-info mb-3 text-fixed-white" style="max-width: 31rem;">
                                        <div class="card-header border-bottom-0">
                                            <div class="card-title text-fixed-white">
                                                Header
                                            </div>
                                    ...
                                    <div class="card text-bg-danger mb-1 text-fixed-white" style="max-width: 31rem;">
                                        <div class="card-header border-bottom-0">
                                            <div class="card-title text-fixed-white">
                                                Header
                                            </div>
                        ...
                        <div class="col-xxl-3 col-lg-6 col-md-6 col-sm-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <img class="bd-placeholder-img card-img-top card-img" src="{{asset('build/assets/images/media/media-4.jpg')}}" alt="...">
                                    <div class="card-body pb-0">
                                        ...
                                        <p class="card-text bg-light p-1 rounded" style="transform: rotate(0);">
                        ...
                        <div class="col-xxl-5 col-lg-12 col-md-12 col-sm-12">
                            <div class="card custom-card">
                                <div class="card-header">
                                    <div class="card-title">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-bg-primary1 p-3">Primary1 with contrasting color</div>
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-evenly flex-wrap">
                                        ...
                                        <a href="javascript:void(0);" class="link-primary1 fw-medium fs-15 p-1">Primary1</a>
                                        <a href="javascript:void(0);" class="link-primary2 fw-medium fs-15 p-1">Primary2</a>
                                        <a href="javascript:void(0);" class="link-primary3 fw-medium fs-15 p-1">Primary3</a>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex gap-3 align-content-center flex-wrap">
                                        ...
                                        <p><a href="javascript:void(0)" class="d-inline-flex focus-ring focus-ring-primary1 py-1 px-2 text-decoration-none border rounded-2">Primary1 focus</a></p>
                                        <p><a href="javascript:void(0)" class="d-inline-flex focus-ring focus-ring-primary2 py-1 px-2 text-decoration-none border rounded-2">Primary2 focus</a></p>
                                        <p><a href="javascript:void(0)" class="d-inline-flex focus-ring focus-ring-primary3 py-1 px-2 text-decoration-none border rounded-2">Primary3 focus</a></p>
