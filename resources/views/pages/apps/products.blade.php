                                    ...
                                    <div class="card custom-card card-style-2">
                                        <div class="card-body p-0">
                                            ...
                                            <div class="card-img-top border-bottom border-block-end-dashed">
                                                ...
                                                <div class="img-box-2 p-2">
                                                    <a href="{{url('product-details')}}">
                                                        <img src="{{asset('build/assets/images/ecommerce/png/14.png')}}" alt="img" class="scale-img img-fluid w-100 bg-primary-transparent  rounded"> 
                                                    </a>
                                                </div>
                                                <a href="{{url('cart')}}" class="btn btn-primary rounded-circle btn-style-1 btn-icon"  data-bs-toggle="tooltip" title="Add to Cart">
                                                    <i class="bx bxs-cart-add fs-18"></i>
                                            ...
                                            <div class="p-3">
                                                <h6 class="mb-1 fw-semibold fs-16"><a href="{{url('product-details')}}">Elegant Flower Pot</a></h6>
                                                <div class="d-flex align-items-end justify-content-between flex-wrap">
                                                    <div class="flex-grow-1">
                                                        <div class="d-flex align-items-baseline fs-11">
                                                            <div class="min-w-fit-content">
                                    ...
                                    <div class="card custom-card card-style-2">
                                        <div class="card-body p-0">
                                            ...
                                            <div class="card-img-top border-bottom border-block-end-dashed">
                                                ...
                                                <div class="img-box-2 p-2">
                                                    <a href="{{url('product-details')}}">
                                                        <img src="{{asset('build/assets/images/ecommerce/png/13.png')}}" alt="img" class="scale-img img-fluid w-100 bg-primary-transparent  rounded"> 
                                                    </a>
                                                </div>
                                                <a href="{{url('cart')}}" class="btn btn-primary rounded-circle btn-style-1 btn-icon"  data-bs-toggle="tooltip" title="Add to Cart">
                                                    <i class="bx bxs-cart-add fs-18"></i>
                                            ...
                                            <div class="p-3">
                                                <h6 class="mb-1 fw-semibold fs-16"><a href="{{url('product-details')}}">Sleek Modern Chair</a></h6>
                                                <div class="d-flex align-items-end justify-content-between flex-wrap">
                                                    <div class="flex-grow-1">
                                                        <div class="d-flex align-items-baseline fs-11">
                                                            <div class="min-w-fit-content">
                                    ...
                                    <div class="card custom-card card-style-2">
                                        <div class="card-body p-0">
                                            ...
                                            <div class="card-img-top border-bottom border-block-end-dashed">
                                                ...
                                                <div class="img-box-2 p-2">
                                                    <img src="{{asset('build/assets/images/ecommerce/png/10.png')}}" alt="img" class="scale-img img-fluid w-100 bg-primary-transparent  rounded"> 
                                                </div>
                                                <a href="{{url('cart')}}" class="btn btn-primary rounded-circle btn-style-1 btn-icon"  data-bs-toggle="tooltip" title="Add to Cart">
                                                    <i class="bx bxs-cart-add fs-18"></i>
                                                </a>
                                            ...
                                            <div class="p-3">
                                                <h6 class="mb-1 fw-semibold fs-16"><a href="{{url('product-details')}}">Classic T-Shirt </a></h6>
                                                <div class="d-flex align-items-end justify-content-between flex-wrap">
                                                <div class="flex-grow-1">
                                                    <div class="d-flex align-items-baseline fs-11">
                                                        <div class="min-w-fit-content">
                                    ...
                                    <div class="card custom-card card-style-2">
                                        <div class="card-body p-0">
                                            ...
                                            <div class="card-img-top border-bottom border-block-end-dashed">
                                                ...
                                                <div class="img-box-2 p-2">
                                                    <a href="{{url('product-details')}}">
                                                        <img src="{{asset('build/assets/images/ecommerce/png/9.png')}}" alt="img" class="scale-img img-fluid w-100 bg-primary-transparent  rounded"> 
                                                    </a>
                                                </div>
                                                <a href="{{url('cart')}}" class="btn btn-primary rounded-circle btn-style-1 btn-icon"  data-bs-toggle="tooltip" title="Add to Cart">
                                                    <i class="bx bxs-cart-add fs-18"></i>
                                            ...
                                            <div class="p-3">
                                                <h6 class="mb-1 fw-semibold fs-16"><a href="{{url('product-details')}}"> Versatile Hoodie</a></h6>
                                                <div class="d-flex align-items-end justify-content-between flex-wrap">
                                                    <div class="flex-grow-1">
                                                        <div class="d-flex align-items-baseline fs-11">
                                                            <div class="min-w-fit-content">
