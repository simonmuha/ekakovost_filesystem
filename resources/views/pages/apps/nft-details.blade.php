                                                    ...
                                                    <div class="row mt-4">
                                                        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-xxl-0 mt-3">
                                                            ...
                                                            <div class="d-flex align-items-center fw-medium">
                                                                <span class="avatar avatar-sm avatar-rounded lh-1 me-1"><img src="{{asset('build/assets/images/nft-images/2.jpg')}}" alt=""></span>
                                                                Digital Art NFT
                                                            </div>
                                                        </div>
                                                        <div class="col-xxl-2 col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-xxl-0 mt-3">
                                                            ...
                                                            <div class="d-flex align-items-center fw-medium">
                                                                <span class="avatar avatar-sm avatar-rounded lh-1 me-1"><img src="{{asset('build/assets/images/faces/9.jpg')}}" alt=""></span>
                                                                Henry Milo
                                                            </div>
                                                        </div>
                                                        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-xxl-0 mt-3">
                                                            ...
                                                            <p class="mb-0">
                                                                <span class="h3">
                                                                    <span class="avatar avatar-sm avatar-rounded p-1 bg-primary-transparent me-2 border border-primary border-opacity-10">
                                                                        <img src="{{asset('build/assets/images/crypto-currencies/regular/Ethereum.svg')}}" alt=""></span>2.299<sup class="fs-14">.00</sup></span>
