                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        <tr class="order-list">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-sm avatar-square bg-gray-300"><img src="{{asset('build/assets/images/ecommerce/png/28.png')}}" class="w-100 h-100" alt="..."></span>
                                                    <div class="ms-2">
                                                        <p class="fw-semibold mb-0 d-flex align-items-center"><a href="{{url('order-details')}}">Lightweight Sneakers</a></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td><span class="badge bg-success-transparent">Shippped</span></td>
                                        ...
                                        <tr class="order-list">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-sm avatar-square bg-gray-300"><img src="{{asset('build/assets/images/ecommerce/png/12.png')}}" class="w-100 h-100" alt="..."></span>
                                                    <div class="ms-2">
                                                        <p class="fw-semibold mb-0 d-flex align-items-center"><a href="{{url('order-details')}}">Kids' Party Wear Frock</a></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="order-list">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-sm avatar-square bg-gray-300"><img src="{{asset('build/assets/images/ecommerce/png/29.png')}}" class="w-100 h-100" alt="..."></span>
                                                    <div class="ms-2">
                                                        <p class="fw-semibold mb-0 d-flex align-items-center"><a href="{{url('order-details')}}">Ladies' Slim Bag</a></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="order-list">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-sm avatar-square bg-gray-300"><img src="{{asset('build/assets/images/ecommerce/png/14.png')}}" class="w-100 h-100" alt="..."></span>
                                                    <div class="ms-2">
                                                        <p class="fw-semibold mb-0 d-flex align-items-center"><a href="{{url('order-details')}}">Elegant Flower Pot</a></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="order-list">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-sm avatar-square bg-gray-300"><img src="{{asset('build/assets/images/ecommerce/png/11.png')}}" class="w-100 h-100" alt="..."></span>
                                                    <div class="ms-2">
                                                        <p class="fw-semibold mb-0 d-flex align-items-center"><a href="{{url('order-details')}}"> Trendy Sunglasses</a></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="order-list">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-sm avatar-square bg-gray-300"><img src="{{asset('build/assets/images/ecommerce/png/13.png')}}" class="w-100 h-100" alt="..."></span>
                                                    <div class="ms-2">
                                                        <p class="fw-semibold mb-0 d-flex align-items-center"><a href="{{url('order-details')}}">Sleek Modern Chair</a></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="order-list">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-sm avatar-square bg-gray-300"><img src="{{asset('build/assets/images/ecommerce/png/30.png')}}" class="w-100 h-100" alt="..."></span>
                                                    <div class="ms-2">
                                                        <p class="fw-semibold mb-0 d-flex align-items-center"><a href="{{url('order-details')}}">Wireless Headphones</a></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="order-list">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-sm avatar-square bg-gray-300"><img src="{{asset('build/assets/images/ecommerce/png/31.png')}}" class="w-100 h-100" alt="..."></span>
                                                    <div class="ms-2">
                                                        <p class="fw-semibold mb-0 d-flex align-items-center"><a href="{{url('order-details')}}">Wireless Earbuds</a></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
