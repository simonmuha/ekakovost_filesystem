                            ...
                            <div class="card custom-card overflow-hidden">
                                <div class="card-header justify-content-between">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        <a href="{{url('job-post')}}" class="btn btn-primary btn-wave btn-sm">
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="{{url('job-details')}}"> HTML Developer - Fresher</a></p>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <a href="javascript:void(0);" class="fw-medium mb-0">HorizonTech Ventures</a>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        Development
                                                    ...
                                                    <td>36</td>
                                                    <td>Full Time</td>
                                                    <td><span class="badge rounded-pill bg-success-transparent">Approved</span></td>
                                                    <td>
                                                        Oct 15 2024
                                                    </td>
                                                    <td>
                                                        ...
                                                        <a href="javascript:void(0);" class="joblist-btn btn btn-icon btn-sm btn-primary2-light btn-wave waves-effect waves-light">
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="{{url('job-details')}}"> React Lead Developer</a></p>
                                                                <p class="fs-12 text-muted mb-0">Remote/Onsite</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <a href="javascript:void(0);" class="fw-medium mb-0">FusionTech Industries</a>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        Design
                                                    ...
                                                    <td>31</td>
                                                    <td><span class="badge bg-danger-transparent"><i class="bi bi-clock me-1"></i>Oct 15 2024</span></td>
                                                    <td>50</td>
                                                    <td>Full Time</td>
                                                    <td>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="{{url('job-details')}}"> Vuejs Frontend Developer</a></p>
                                                                <p class="fs-12 text-muted mb-0">Remote/Onsite</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <a href="javascript:void(0);" class="fw-medium mb-0">Optima Ventures Inc.</a>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        Management
                                                    ...
                                                    <td>36</td>
                                                    <td><span class="badge bg-primary-transparent"><i class="bi bi-clock me-1"></i>May 15 2024</span></td>
                                                    <td>35</td>
                                                    <td>Part Time</td>
                                                    <td>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="{{url('job-details')}}"> Wordpress Developer - Remote</a></p>
                                                                <p class="fs-12 text-muted mb-0">Remote/Onsite</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <a href="javascript:void(0);" class="fw-medium mb-0">Tech Innovators Ltd.</a>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        Marketing
                                                    ...
                                                    <td>Part Time</td>
                                                    <td>
                                                        <span class="badge rounded-pill bg-success-transparent">Approved</span>
                                                    </td>
                                                    <td>
                                                        Jan 12 2024
                                                    </td>
