                    ...
                    <div class="row">
                        <div class="col-xxl-5">
                            <div class="card custom-card">
                                <div class="card-body">
                                    <a href="{{asset('build/assets/images/ecommerce/png/1.png')}}" class="glightbox card border-0 mb-0" data-gallery="gallery1" data-title="Compact Laptop (1/5)" data-type="image" data-draggable="true"> 
                                    ...
                                    <div class="row ad-gallery">
                                        <div class="col-xl-3">
                                            <a href="{{asset('build/assets/images/ecommerce/png/2.png')}}" class="glightbox card" data-gallery="gallery1" data-title="Grey Laptop (2/5)" data-type="image" data-draggable="true">
                                                <img src="{{asset('build/assets/images/ecommerce/png/2.png')}}" alt="image" >
                                            </a>
                                        </div>
                                        <div class="col-xl-3">
                                            <a href="{{asset('build/assets/images/ecommerce/png/3.png')}}" class="glightbox card" data-gallery="gallery1" data-title="Litson's Laptop (3/5)" data-type="image" data-draggable="true">
                                                <img src="{{asset('build/assets/images/ecommerce/png/3.png')}}" alt="image" >
                                            </a>
                                        </div>
                                        <div class="col-xl-3">
                                            <a href="{{asset('build/assets/images/ecommerce/png/4.png')}}" class="glightbox card" data-gallery="gallery1" data-title="Prism Laptop (4/5)" data-type="image" data-draggable="true">
                                                <img src="{{asset('build/assets/images/ecommerce/png/4.png')}}" alt="image" >
                                            </a>
                                        </div>
                                        <div class="col-xl-3">
                                            <a href="{{asset('build/assets/images/ecommerce/png/5.png')}}" class="glightbox card" data-gallery="gallery1" data-title="Trends Laptop (5/5)" data-type="image" data-draggable="true">
                                ...
                                <div class="card-footer text-center d-flex gap-2 flex-wrap justify-content-center">
                                    <a href="{{url('checkout')}}" class="btn btn-primary btn-w-lg me-2"><i class="bx bx-credit-card fs-16 align-middle"></i> Buy Now</a>
                                    <a href="{{url('cart')}}" class="btn btn-primary1 btn-w-lg"><i class="bx bx-cart-add fs-16 align-middle"></i> Add to Cart</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xxl-7">
                                    ...
                                    <div>
                                        ...
                                        <div class="d-flex align-items-center gap-2 flex-wrap">
                                            ...
                                            <div class="ms-auto d-flex gap-2">
                                                ...
                                                <a href="{{url('wishlist')}}" class="btn-primary btn">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card-img-top border-bottom border-block-end-dashed">
                                            <div class="btns-container-1 align-items-center gap-1">
                                                ...
                                                <a href="{{url('wishlist')}}" class="btn btn-icon btn-primary1 rounded-circle" data-bs-toggle="tooltip" aria-label="Add to Wishlist" data-bs-original-title="Add to Wishlist"><i class="bx bx-heart align-center"></i></a>
                                            ...
                                            <div class="img-box-2 p-2">
                                                <img src="{{asset('build/assets/images/ecommerce/png/28.png')}}" alt="img" class="scale-img img-fluid w-100 bg-primary-transparent rounded"> 
                                            </div>
                                        ...
                                        <div class="p-3">
                                            <h6 class="mb-1 fw-semibold fs-16"><a href="{{url('product-details')}}">Lightweight Sneakers</a></h6>
                                ...
                                <div class="card custom-card card-style-2">
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card-img-top border-bottom border-block-end-dashed">
                                            ...
                                            <div class="img-box-2 p-2">
                                                <img src="{{asset('build/assets/images/ecommerce/png/11.png')}}" alt="img" class="scale-img img-fluid w-100 bg-primary-transparent rounded"> 
                                            </div>
                                            <a href="javascript:void(0);" class="btn btn-primary rounded-circle btn-style-1 btn-icon"  data-bs-toggle="tooltip" title="Add to Cart">
                                                <i class="bx bxs-cart-add fs-18"></i>
                                            </a>
                                        ...
                                        <div class="p-3">
                                            <h6 class="mb-1 fw-semibold fs-16"><a href="{{url('product-details')}}">Trendy Sunglasses</a></h6>
                                            <div class="d-flex align-items-end justify-content-between flex-wrap">
                                                <div class="flex-grow-1">
                                                    <div class="d-flex align-items-baseline fs-11">
                                                        <div class="min-w-fit-content">
                                        ...
                                        <div class="card-img-top border-bottom border-block-end-dashed">
                                            ...
                                            <div class="img-box-2 p-2">
                                                <a href="{{url('product-details')}}">
                                                    <img src="{{asset('build/assets/images/ecommerce/png/30.png')}}" alt="img" class="scale-img img-fluid w-100 bg-primary-transparent  rounded"> 
                                                </a>
                                            </div>
                                            <a href="{{url('cart')}}" class="btn btn-primary rounded-circle btn-style-1 btn-icon"  data-bs-toggle="tooltip" title="Add to Cart">
                                                <i class="bx bxs-cart-add fs-18"></i>
                                            </a>
                                        </div>
                                        <div class="p-3">
                                            <h6 class="mb-1 fw-semibold fs-16"><a href="{{url('product-details')}}">Wireless Headphones</a></h6>
                                            <div class="d-flex align-items-end justify-content-between flex-wrap">
                                                <div class="flex-grow-1">
                                                    <div class="d-flex align-items-baseline fs-11">
                                                        <div class="min-w-fit-content">
                                ...
                                <div class="card custom-card card-style-2">
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card-img-top border-bottom border-block-end-dashed">
                                            ...
                                            <div class="img-box-2 p-2">
                                                <a href="{{url('product-details')}}">
                                                    <img src="{{asset('build/assets/images/ecommerce/png/31.png')}}" alt="img" class="scale-img img-fluid w-100 bg-primary-transparent  rounded"> 
                                                </a>
                                            </div>
                                            <a href="{{url('cart')}}" class="btn btn-primary rounded-circle btn-style-1 btn-icon"  data-bs-toggle="tooltip" title="Add to Cart">
                                                <i class="bx bxs-cart-add fs-18"></i>
                                        ...
                                        <div class="p-3">
                                            <h6 class="mb-1 fw-semibold fs-16"><a href="{{url('product-details')}}"> Wireless Earbuds</a></h6>
                                            <div class="d-flex align-items-end justify-content-between flex-wrap">
                                                <div class="flex-grow-1">
                                                    <div class="d-flex align-items-baseline fs-11">
                                                        <div class="min-w-fit-content">
                                ...
                                <div class="card custom-card card-style-2">
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card-img-top border-bottom border-block-end-dashed">
                                            ...
                                            <div class="img-box-2 p-2">
                                                <a href="{{url('product-details')}}">
                                                    <img src="{{asset('build/assets/images/ecommerce/png/12.png')}}" alt="img" class="scale-img img-fluid w-100 bg-primary-transparent  rounded"> 
                                                </a>
                                            </div>
                                            <a href="{{url('cart')}}" class="btn btn-primary rounded-circle btn-style-1 btn-icon"  data-bs-toggle="tooltip" title="Add to Cart">
                                                <i class="bx bxs-cart-add fs-18"></i>
                                        ...
                                        <div class="p-3">
                                            <h6 class="mb-1 fw-semibold fs-16"><a href="{{url('product-details')}}"> Kids' Party Wear Frock</a></h6>
                                            <div class="d-flex align-items-end justify-content-between flex-wrap">
                                                <div class="flex-grow-1">
                                                    <div class="d-flex align-items-baseline fs-11">
                                                        <div class="min-w-fit-content">
                                ...
                                <div class="card custom-card card-style-2">
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card-img-top border-bottom border-block-end-dashed">
                                            ...
                                            <div class="img-box-2 p-2">
                                                <a href="{{url('product-details')}}">
                                                    <img src="{{asset('build/assets/images/ecommerce/png/29.png')}}" alt="img" class="scale-img img-fluid w-100 bg-primary-transparent  rounded"> 
                                                </a>
                                            </div>
                                            <a href="{{url('cart')}}" class="btn btn-primary rounded-circle btn-style-1 btn-icon"  data-bs-toggle="tooltip" title="Add to Cart">
                                                <i class="bx bxs-cart-add fs-18"></i>
                                        ...
                                        <div class="p-3">
                                            <h6 class="mb-1 fw-semibold fs-16"><a href="{{url('product-details')}}">Ladies' Slim Bag</a></h6>
                                            <div class="d-flex align-items-end justify-content-between flex-wrap">
                                                <div class="flex-grow-1">
                                                    <div class="d-flex align-items-baseline fs-11">
                                                        <div class="min-w-fit-content">
                                ...
                                <div class="card custom-card card-style-2">
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card-img-top border-bottom border-block-end-dashed">
                                            ...
                                            <div class="img-box-2 p-2">
                                                <a href="{{url('product-details')}}">
                                                    <img src="{{asset('build/assets/images/ecommerce/png/23.png')}}" alt="img" class="scale-img img-fluid w-100 bg-primary-transparent  rounded"> 
                                                </a>
                                            </div>
                                            <a href="{{url('cart')}}" class="btn btn-primary rounded-circle btn-style-1 btn-icon"  data-bs-toggle="tooltip" title="Add to Cart">
                                                <i class="bx bxs-cart-add fs-18"></i>
                                        ...
                                        <div class="p-3">
                                            <h6 class="mb-1 fw-semibold fs-16"><a href="{{url('product-details')}}"> Advanced Smartwatch</a></h6>
                                            <div class="d-flex align-items-end justify-content-between flex-wrap">
                                                <div class="flex-grow-1">
                                                    <div class="d-flex align-items-baseline fs-11">
                                                        <div class="min-w-fit-content">
