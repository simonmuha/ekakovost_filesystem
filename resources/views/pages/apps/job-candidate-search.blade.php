                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                ...
                                                <div>
                                                    <h6 class="fw-medium mb-1 d-flex align-items-center"><a href="{{url('job-candidate-details')}}"> Samantha <i class="ri-verified-badge-fill text-primary fs-14" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h6>
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                ...
                                                <div>
                                                    <h6 class="fw-medium mb-1 d-flex align-items-center"><a href="{{url('job-candidate-details')}}"> Michael <i class="ri-verified-badge-fill text-primary fs-14" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h6>
                                                    <div class="d-flex gap-2 flex-wrap">
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                ...
                                                <div>
                                                    <h6 class="fw-medium mb-1 d-flex align-items-center"><a href="{{url('job-candidate-details')}}"> Emily <i class="ri-verified-badge-fill text-primary fs-14" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h6>
                                                    <div class="d-flex gap-2 flex-wrap">
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                ...
                                                <div>
                                                    <h6 class="fw-medium mb-1 d-flex align-items-center"><a href="{{url('job-candidate-details')}}"> James <i class="ri-verified-badge-fill text-primary fs-14" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h6>
                                                    <div class="d-flex gap-2 flex-wrap">
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                ...
                                                <div>
                                                    <h6 class="fw-medium mb-1 d-flex align-items-center"><a href="{{url('job-candidate-details')}}"> Alexander <i class="ri-verified-badge-fill text-primary fs-14" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h6>
                                                    <div class="d-flex gap-2 flex-wrap">
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                ...
                                                <div>
                                                    <h6 class="fw-medium mb-1 d-flex align-items-center"><a href="{{url('job-candidate-details')}}"> Sophia <i class="ri-verified-badge-fill text-primary fs-14" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h6>
                                                    <div class="d-flex gap-2 flex-wrap">
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                ...
                                                <div>
                                                    <h6 class="fw-medium mb-1 d-flex align-items-center"><a href="{{url('job-candidate-details')}}"> Marcus <i class="ri-verified-badge-fill text-primary fs-14" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h6>
                                                    <div class="d-flex gap-2 flex-wrap">
                                                        <a href="javascript:void(0);">Software Engineer</a>
                                                        <p class="mb-0 fs-12 text-muted"><i class="ri-map-pin-line fs-11"></i> New York City, NY</p>
                                                    </div> 
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                ...
                                                <div>
                                                    <h6 class="fw-medium mb-1 d-flex align-items-center"><a href="{{url('job-candidate-details')}}"> Lucas <i class="ri-verified-badge-fill text-primary fs-14" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h6>
                                                    <div class="d-flex gap-2 flex-wrap">
                                                        <a href="javascript:void(0);">Data Analyst</a>
                                                        <p class="mb-0 fs-12 text-muted"><i class="ri-map-pin-line fs-11"></i> Toronto, Canada</p>
                                                    </div> 
