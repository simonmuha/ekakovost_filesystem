...
@section('content')
                    ...
                    <div class="d-flex align-items-center justify-content-between page-header-breadcrumb flex-wrap gap-2">
                        <div>
                            ...
                            <h1 class="page-title fw-medium fs-18 mb-0">Edit Products</h1>
                        </div>
                        <div class="btn-list">
                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-footer border-top border-block-start-dashed d-sm-flex justify-content-end">
                                    <button class="btn btn-primary1-light me-2 mb-2 mb-sm-0">Add Product<i class="bi bi-plus-lg ms-2"></i></button>
