...
@section('content')
                    ...
                    <div class="d-flex align-items-center justify-content-between page-header-breadcrumb flex-wrap gap-2">
                        <div>
                            ...
                            <h1 class="page-title fw-medium fs-18 mb-0">Products List</h1>
                        </div>
                        <div class="btn-list">
                                        ...
                                        <table class="table text-nowrap table-bordered">
                                            ...
                                            <tbody>
                                                <tr class="product-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <span class="avatar avatar-md avatar-square bg-light"><img src="{{asset('build/assets/images/ecommerce/png/30.png')}}" class="w-100 h-100" alt="..."></span>
                                                            <div class="ms-2">
                                                                <p class="fw-semibold mb-0 d-flex align-items-center"><a href="javascript:void(0);"> Wireless Headphones</a></p>
                                                                <p class="fs-12 text-muted mb-0">SoundWave</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="hstack gap-2 fs-15">
                                                            <a href="{{url('edit-products')}}" class="btn btn-icon btn-sm btn-primary-light"><i class="ri-edit-line"></i></a>
                                                ...
                                                <tr class="product-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <span class="avatar avatar-md avatar-square bg-light"><img src="{{asset('build/assets/images/ecommerce/png/14.png')}}" class="w-100 h-100" alt="..."></span>
                                                            <div class="ms-2">
                                                                <p class="fw-semibold mb-0 d-flex align-items-center"><a href="javascript:void(0);"> Elegant Flower Pot</a></p>
                                                ...
                                                <tr class="product-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <span class="avatar avatar-md avatar-square bg-light"><img src="{{asset('build/assets/images/ecommerce/png/31.png')}}" class="w-100 h-100" alt="..."></span>
                                                            <div class="ms-2">
                                                                <p class="fw-semibold mb-0 d-flex align-items-center"><a href="javascript:void(0);">Wireless Earbuds</a></p>
                                                ...
                                                <tr class="product-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <span class="avatar avatar-md avatar-square bg-light"><img src="{{asset('build/assets/images/ecommerce/png/12.png')}}" class="w-100 h-100" alt="..."></span>
                                                            <div class="ms-2">
                                                                <p class="fw-semibold mb-0 d-flex align-items-center"><a href="javascript:void(0);">Kids' Party Wear Frock</a></p>
                                                ...
                                                <tr class="product-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <span class="avatar avatar-md avatar-square bg-light"><img src="{{asset('build/assets/images/ecommerce/png/32.png')}}" class="w-100 h-100" alt="..."></span>
                                                            <div class="ms-2">
                                                ...
                                                <tr class="product-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <span class="avatar avatar-md avatar-square bg-light"><img src="{{asset('build/assets/images/ecommerce/png/23.png')}}" class="w-100 h-100" alt="..."></span>
                                                            <div class="ms-2">
                                                                <p class="fw-semibold mb-0 d-flex align-items-center"><a href="javascript:void(0);">Advanced Smartwatch</a></p>
                                                ...
                                                <tr class="product-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <span class="avatar avatar-md avatar-square bg-light"><img src="{{asset('build/assets/images/ecommerce/png/15.png')}}" class="w-100 h-100" alt="..."></span>
                                                            <div class="ms-2">
