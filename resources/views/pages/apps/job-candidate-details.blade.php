                                ...
                                <div class="card-body pt-5">
                                    <div class="mb-3 lh-1 mt-4">
                                        <span class="avatar avatar-xxl avatar-rounded">
                                            <img src="{{asset('build/assets/images/faces/1.jpg')}}" class="rounded-circle img-fluid shadow" alt="">
                                        </span>
                                    </div>
                                            ...
                                            <div class="card custom-card shadow-none border">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                        <div>
                                                            <span class="avatar avatar-lg avatar-rounded">
                                                                <img src="{{asset('build/assets/images/faces/11.jpg')}}" alt="Profile Picture">
                                                            </span>
                                                        </div>    
                                                        <div>
                                            ...
                                            <div class="card custom-card shadow-none border">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <h6 class="fw-medium mb-1 d-flex align-items-center"><a href="{{url('job-candidate-details')}}"> Joseph <i class="ri-verified-badge-fill text-primary fs-14" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h6>
                                                            <div class="d-flex gap-2 flex-wrap">
