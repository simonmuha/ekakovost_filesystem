                                                        ...
                                                        <div class="text-center p-4">
                                                            ...
                                                            <div class="mb-0">
                                                                <div class="form-check d-inline-block">
                                                                    <input class="form-check-input" id="customCheck1" required="" type="checkbox"> <label class="form-check-label" for="customCheck1">I agree with the <a class="fw-medium text-decoration-underline" href="{{url('terms-conditions')}}">Terms and Conditions.</a></label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div><!-- end col -->
                                                ...
                                                <div class="row d-flex justify-content-center">
                                                    <div class="col-lg-10">
                                                        <div class="text-center p-4">
                                                            ...
                                                            <div class="mb-0">
                                                                <div class="form-check d-inline-block">
                                                                    <input class="form-check-input" id="customCheck2" required="" type="checkbox"> <label class="form-check-label" for="customCheck2">I agree with the <a class="fw-medium text-decoration-underline" href="{{url('terms-conditions')}}">Terms and Conditions.</a></label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div><!-- end col -->
...
@section('scripts')
        ...
        <!-- Vanilla-Wizard JS -->
        <script src="{{asset('build/assets/libs/vanilla-wizard/js/wizard.min.js')}}"></script>
