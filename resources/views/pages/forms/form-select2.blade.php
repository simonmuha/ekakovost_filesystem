...
@section('content')
                ...
                <div class="alert alert-primary alert-dismissible fs-15 fade show mb-4">
                    We Placed <strong class="text-primary1 text-decoration-underline">Select2</strong> only in this page by using <strong class="text-primary1 text-decoration-underline">jquery</strong> cdn link.
