                                ...
                                <div class="card-body">
                                    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item">
                                                <img src="{{asset('build/assets/images/media/media-32.jpg')}}" class="d-block w-100" alt="...">
                                            </div>
                                        </div>
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div id="carouselExampleDark" class="carousel slide" data-bs-ride="carousel">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active" data-bs-interval="10000">
                                                <img src="{{asset('build/assets/images/media/media-63.jpg')}}" class="d-block w-100"
                                                    alt="...">
                                                <div class="carousel-caption d-none d-md-block">
                                                    <h5 class="text-fixed-white">First slide label</h5>
                                            ...
                                            <div class="carousel-item" data-bs-interval="2000">
                                                <img src="{{asset('build/assets/images/media/media-64.jpg')}}" class="d-block w-100"
                                                    alt="...">
                                                <div class="carousel-caption d-none d-md-block">
                                                    <h5 class="text-fixed-white">Second slide label</h5>
                                            ...
                                            <div class="carousel-item">
                                                <img src="{{asset('build/assets/images/media/media-62.jpg')}}" class="d-block w-100"
                                                    alt="...">
                                                <div class="carousel-caption d-none d-md-block">
                                                    <h5 class="text-fixed-white">Third slide label</h5>
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false"
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img src="{{asset('build/assets/images/media/media-13.jpg')}}" class="d-block w-100" alt="...">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="{{asset('build/assets/images/media/media-14.jpg')}}" class="d-block w-100" alt="...">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="{{asset('build/assets/images/media/media-18.jpg')}}" class="d-block w-100" alt="...">
                                            </div>
                                        </div>
                                        <button class="carousel-control-prev" type="button"
