                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div class="btn-list">
                                        ...
                                        <button type="button" class="btn btn-primary1 btn-wave" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-primary1"
                                            data-bs-placement="bottom" title="Primary1 Tooltip">
                                            Primary1 Tooltip
                                        </button>
                                        <button type="button" class="btn btn-primary2 btn-wave" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-primary2"
                                            data-bs-placement="right" title="Primary2 Tooltip">
                                            Primary2 Tooltip
                                        </button>
                                        <button type="button" class="btn btn-primary3 btn-wave" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-primary3"
                                            data-bs-placement="top" title="Primary3 Tooltip">
                                            Primary3 Tooltip
                                        </button>
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <a href="javascript:void(0);" data-bs-toggle="tooltip" title="Phillip John" data-bs-custom-class="tooltip-primary" class="avatar avatar-md me-2 online avatar-rounded">
                                ...
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-html"><code class="language-html">&lt;a href="javascript:void(0);" data-bs-toggle="tooltip" title="Phillip John" data-bs-custom-class="tooltip-primary" class="avatar avatar-md me-2 online avatar-rounded"&gt;
    &lt;img src="{{asset('build/assets/images/faces/12.jpg')}}" alt="img"&gt;
&lt;/a&gt;
&lt;a href="javascript:void(0);" data-bs-toggle="tooltip" title="Marina Kai" data-bs-custom-class="tooltip-primary" class="avatar avatar-lg me-2 online avatar-rounded"&gt;
    &lt;img src="{{asset('build/assets/images/faces/3.jpg')}}" alt="img"&gt;
