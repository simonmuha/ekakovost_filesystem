                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-primary1" role="alert">
                                        A simple primary1 alert—check it out!
                                    </div>
                                    <div class="alert alert-primary2" role="alert">
                                        A simple primary2 alert—check it out!
                                    </div>
                                    <div class="alert alert-primary3" role="alert">
                                        A simple primary3 alert—check it out!
                                    </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-primary1" role="alert">
                                        A simple primary1 alert with <a href="javascript:void(0);" class="alert-link">an example
                                            link</a>. Give it a click if you like.
                                    </div>
                                    <div class="alert alert-primary2" role="alert">
                                        A simple primary2 alert with <a href="javascript:void(0);" class="alert-link">an example
                                            link</a>. Give it a click if you like.
                                    </div>
                                    <div class="alert alert-primary3" role="alert">
                                        A simple primary3 alert with <a href="javascript:void(0);" class="alert-link">an example
                                            link</a>. Give it a click if you like.
                                    </div>
                                    <div class="alert alert-secondary" role="alert">
                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-solid-primary1 alert-dismissible fade show">
                                        A simple solid primary1 alert—check it out!
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                    </div>
                                    <div class="alert alert-solid-primary2 alert-dismissible fade show">
                                        A simple solid primary2 alert—check it out!
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                    </div>
                                    <div class="alert alert-solid-primary3 alert-dismissible fade show">
                                        A simple solid primary3 alert—check it out!
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                    </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-solid-primary1 rounded-pill alert-dismissible fade show">
                                        A simple solid rounded primary1 alert—check it out!
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                    </div>
                                    <div class="alert alert-solid-primary2 rounded-pill alert-dismissible fade show">
                                        A simple solid rounded primary2 alert—check it out!
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                    </div>
                                    <div class="alert alert-solid-primary3 rounded-pill alert-dismissible fade show">
                                        A simple solid rounded primary3 alert—check it out!
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                    </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-outline-primary1 alert-dismissible fade show">
                                        A simple outline primary1 alert—check it out!
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                    </div>
                                    <div class="alert alert-outline-primary2 alert-dismissible fade show">
                                        A simple outline primary2 alert—check it out!
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                    </div>
                                    <div class="alert alert-outline-primary3 alert-dismissible fade show">
                                        A simple outline primary3 alert—check it out!
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                    </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-outline-primary1 rounded-pill alert-dismissible fade show">
                                        A simple outline rounded primary1 alert—check it out!
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                    </div>
                                    <div class="alert alert-outline-primary2 rounded-pill alert-dismissible fade show">
                                        A simple outline rounded primary2 alert—check it out!
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                    </div>
                                    <div class="alert alert-outline-primary3 rounded-pill alert-dismissible fade show">
                                        A simple outline rounded primary3 alert—check it out!
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                    </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-primary1 rounded-pill alert-dismissible fade show">
                                        A simple rounded primary1 alert—check it out!
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                    </div>
                                    <div class="alert alert-primary2 rounded-pill alert-dismissible fade show">
                                        A simple rounded primary2 alert—check it out!
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                    </div>
                                    <div class="alert alert-primary3 rounded-pill alert-dismissible fade show">
                                        A simple rounded primary3 alert—check it out!
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                    </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-img alert-primary1 alert-dismissible fase show rounded-pill flex-wrap" role="alert">
                                        <div class="avatar avatar-sm me-3 avatar-rounded">
                                            <img src="{{asset('build/assets/images/faces/9.jpg')}}" alt="img">
                                        </div>
                                        <div>A simple primary1 alert with image—check it out!</div>
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                    </div>
                                    <div class="alert alert-img alert-primary2 alert-dismissible fase show rounded-pill flex-wrap" role="alert">
                                        <div class="avatar avatar-sm me-3 avatar-rounded">
                                            <img src="{{asset('build/assets/images/faces/12.jpg')}}" alt="img">
                                        </div>
                                        <div>A simple primary2 alert with image—check it out!</div>
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                    </div>
                                    <div class="alert alert-img alert-primary3 alert-dismissible fase show rounded-pill flex-wrap" role="alert">
                                        <div class="avatar avatar-sm me-3 avatar-rounded">
                                            <img src="{{asset('build/assets/images/faces/15.jpg')}}" alt="img">
                                        </div>
                                        <div>A simple primary3 alert with image—check it out!</div>
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                    </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-img alert-primary1 alert-dismissible fase show flex-wrap" role="alert">
                                        <div class="avatar avatar-xs me-3">
                                            <img src="{{asset('build/assets/images/faces/3.jpg')}}" alt="img">
                                        </div>
                                        <div>A simple primary1 alert with image—check it out!</div>
                                    ...
                                    <div class="alert alert-img alert-primary2 alert-dismissible fase show flex-wrap" role="alert">
                                        <div class="avatar avatar-xs me-3">
                                            <img src="{{asset('build/assets/images/faces/3.jpg')}}" alt="img">
                                        </div>
                                        <div>A simple primary2 alert with image—check it out!</div>
                                    ...
                                    <div class="alert alert-img alert-primary3 alert-dismissible fase show flex-wrap" role="alert">
                                        <div class="avatar avatar-xs me-3">
                                            <img src="{{asset('build/assets/images/faces/3.jpg')}}" alt="img">
                                        </div>
                                        <div>A simple primary3 alert with image—check it out!</div>
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="alert alert-primary1 overflow-hidden p-0" role="alert">
                                                <div class="p-3 bg-primary1 text-fixed-white d-flex justify-content-between">
                                                    <h6 class="aletr-heading mb-0 text-fixed-white">Thank you for reporting this.</h6>
                                                    <button type="button" class="btn-close p-0 text-fixed-white" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                                </div>
                                                <hr class="my-0">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="alert alert-primary2 overflow-hidden p-0" role="alert">
                                                <div class="p-3 bg-primary2 text-fixed-white d-flex justify-content-between">
                                                    <h6 class="aletr-heading mb-0 text-fixed-white">Thank you for reporting this.</h6>
                                                    <button type="button" class="btn-close p-0 text-fixed-white" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                                </div>
                                                <hr class="my-0">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="alert alert-primary3 overflow-hidden p-0" role="alert">
                                                <div class="p-3 bg-primary3 text-fixed-white d-flex justify-content-between">
                                                    <h6 class="aletr-heading mb-0 text-fixed-white">Thank you for reporting this.</h6>
                                                    <button type="button" class="btn-close p-0 text-fixed-white" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                                </div>
                                                <hr class="my-0">
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-12">
                            <div class="row">
                                ...
                                <div class="col-xl-3">
                                    <div class="card border-0">
                                        <div class="alert alert-primary1 border border-primary1 mb-0 p-2">
                                            <div class="d-flex align-items-start">
                                                <div class="me-2 svg-primary1">
                                                    <svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><path d="M0 0h24v24H0V0zm0 0h24v24H0V0z" fill="none"/><path d="M16.59 7.58L10 14.17l-3.59-3.58L5 12l5 5 8-8zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/></svg>
                                                </div>
                                                <div class="text-primary1 w-100">
                                                    ...
                                                    <div class="fs-12 d-inline-flex">
                                                        ...
                                                        <a href="javascript:void(0);" class="text-primary1 fw-medium">open</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-3">
                                    <div class="card border-0">
                                        <div class="alert alert-primary2 border border-primary2 mb-0 p-2">
                                            <div class="d-flex align-items-start">
                                                <div class="me-2 svg-primary2">
                                                    <svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><g><rect fill="none" height="24" width="24"/></g><g><g><g><path d="M12,5.99L19.53,19H4.47L12,5.99 M12,2L1,21h22L12,2L12,2z"/><polygon points="13,16 11,16 11,18 13,18"/><polygon points="13,10 11,10 11,15 13,15"/></g></g></g></svg>
                                                </div>
                                                <div class="text-primary2 w-100">
                                                    ...
                                                    <div class="fs-12 d-inline-flex">
                                                        ...
                                                        <a href="javascript:void(0);" class="text-primary2 fw-medium">open</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
