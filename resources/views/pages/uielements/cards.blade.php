                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                ...
                                <img src="{{asset('build/assets/images/media/media-28.jpg')}}" class="card-img-bottom" alt="...">
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="card custom-card">
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                ...
                                <img src="{{asset('build/assets/images/media/media-33.jpg')}}" class="card-img-bottom" alt="...">
                            </div>
                        </div>
                    </div>
                    <!-- End::row-6 -->
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                <div class="row g-0">
                                    <div class="col-md-4">
                                        <img src="{{asset('build/assets/images/media/media-37.jpg')}}" class="img-fluid rounded-start h-100 w-100" alt="...">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-header">
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-4">
                                        <img src="{{asset('build/assets/images/media/media-38.jpg')}}" class="img-fluid rounded-end h-100 w-100" alt="...">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-4">
                                        <img src="{{asset('build/assets/images/media/media-39.jpg')}}" class="img-fluid rounded-end h-100 w-100" alt="...">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-xxl-7 col-xl-12">
                                    <div class="card custom-card">
                                        ...
                                        <div class="row g-0">
                                            ...
                                            <div class="col-md-4">
                                                <img src="{{asset('build/assets/images/media/media-39.jpg')}}" class="img-fluid rounded-sm-end rounded-bottom h-100 w-100" alt="...">
                                            </div>
                                        </div>
                                    </div>
                                </div>
