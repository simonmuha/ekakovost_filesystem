                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div class="btn-list">
                                        ...
                                        <button type="button" class="btn btn-outline-primary1 btn-wave" data-bs-toggle="popover"
                                            data-bs-placement="bottom" data-bs-custom-class="header-primary1"
                                            title="Color Header" data-bs-content="Popover with primary1 header.">
                                            Header Primary1
                                        </button>
                                        <button type="button" class="btn btn-outline-primary2 btn-wave" data-bs-toggle="popover"
                                            data-bs-placement="right" data-bs-custom-class="header-primary2"
                                            title="Color Header" data-bs-content="Popover with primary2 header.">
                                            Header Primary2
                                        </button>
                                        <button type="button" class="btn btn-outline-primary3 btn-wave" data-bs-toggle="popover"
                                            data-bs-placement="top" data-bs-custom-class="header-primary3"
                                            title="Color Header" data-bs-content="Popover with primary3 header.">
                                            Header Primary3
                                        </button>
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div class="btn-list">
                                        ...
                                        <button type="button" class="btn btn-primary1 btn-wave" data-bs-toggle="popover"
                                            data-bs-placement="bottom" data-bs-custom-class="popover-primary1"
                                            title="Color Background" data-bs-content="Popover with primary1 background.">
                                            Primary1
                                        </button>
                                        <button type="button" class="btn btn-primary2 btn-wave" data-bs-toggle="popover"
                                            data-bs-placement="right" data-bs-custom-class="popover-primary2"
                                            title="Color Background" data-bs-content="Popover with primary2 background.">
                                            Primary2
                                        </button>
                                        <button type="button" class="btn btn-primary3 btn-wave" data-bs-toggle="popover"
                                            data-bs-placement="top" data-bs-custom-class="popover-primary3"
                                            title="Color Background" data-bs-content="Popover with primary3 background.">
                                            Primary3
                                        </button>
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div class="btn-list">
                                        ...
                                        <button type="button" class="btn btn-primary1-light btn-wave" data-bs-toggle="popover"
                                            data-bs-placement="bottom" data-bs-custom-class="popover-primary1-light"
                                            title="Light Background" data-bs-content="Popover with light primary1 background.">
                                            Primary1
                                        </button>
                                        <button type="button" class="btn btn-primary2-light btn-wave" data-bs-toggle="popover"
                                            data-bs-placement="right" data-bs-custom-class="popover-primary2-light"
                                            title="Light Background" data-bs-content="Popover with light primary2 background.">
                                            Primary2
                                        </button>
                                        <button type="button" class="btn btn-primary3-light btn-wave" data-bs-toggle="popover"
                                            data-bs-placement="top" data-bs-custom-class="popover-primary3-light"
                                            title="Light Background" data-bs-content="Popover with light primary3 background.">
                                            Primary3
                                        </button>
