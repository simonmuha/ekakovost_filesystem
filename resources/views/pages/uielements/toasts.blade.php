...
@section('styles')
        ...
        <!-- Toastify CSS -->
        <link rel="stylesheet" href="{{asset('build/assets/libs/toastify-js/src/toastify.css')}}">
                                ...
                                <div class="card-body">
                                    <div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
                                        <div class="toast-header text-default">
                                            <img class="bd-placeholder-img rounded me-1" src="{{asset('build/assets/images/brand-logos/toggle-logo.png')}}" alt="...">
                                    ...
                                    <div class="toast-container position-fixed top-0 end-0 p-3">
                                        <div id="solid-primaryToast" class="toast colored-toast bg-primary text-fixed-white" role="alert" aria-live="assertive"
                                            ...
                                            <div class="toast-header bg-primary text-fixed-white">
                                                <img class="bd-placeholder-img rounded me-1" src="{{asset('build/assets/images/brand-logos/toggle-dark.png')}}" alt="...">
                                                <strong class="me-auto">Xintra</strong>
                                                <button type="button" class="btn-close" data-bs-dismiss="toast"
                                                    aria-label="Close"></button>
                                            </div>
...
@section('scripts')
        ...
        <!-- Toastify JS -->
        <script src="{{asset('build/assets/libs/toastify-js/src/toastify.js')}}"></script>
