                                                ...
                                                <table class="table mb-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <th scope="row">
                                                                <span class="avatar avatar-sm bg-primary-transparent">
                                                                    <img src="{{asset('build/assets/images/ecommerce/png/32.png')}}" alt="img">
                                                                </span>
                                                            </th>
                                                            <td>Alarm Clock</td>
                                                            <td>Clocks</td>
                                                        ...
                                                        <tr>
                                                            <th scope="row">
                                                                <span class="avatar avatar-sm bg-primary-transparent">
                                                                    <img src="{{asset('build/assets/images/ecommerce/png/23.png')}}" alt="img">
                                                                </span>
                                                            </th>
                                                            <td>Wrist Watch</td>
                                                            <td>Gadgets</td>
                                                    ...
                                                    <div class="d-sm-flex">
                                                        ...
                                                        <div>
                                                            <div class="my-md-auto mt-4 ms-md-3">
                                                                <h5 class="font-weight-semibold ms-2 mb-1 pb-0">Gatin Leo</h5>
