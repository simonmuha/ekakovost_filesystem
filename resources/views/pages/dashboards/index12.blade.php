                                ...
                                <div class="card-body p-4">
                                    <div class="row mx-0">
                                        <div class="col-md-8">
                                            ...
                                            <div class="mt-3"> 
                                                <button class="btn btn-primary1 btn-wave waves-effect waves-light btn-lg">Get Started <i class="ti ti-arrow-narrow-right ms-1"></i></button> 
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <img src="{{asset('build/assets/images/media/media-71.png')}}" alt="" class="img-fluid med-banner-img">
                            </div>
                        </div>
                        <div class="col-xxl-5">
                            <div class="row">
                                        ...
                                        <table class="table text-nowrap">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            <span class="avatar avatar-xs avatar-rounded"><img src="{{asset('build/assets/images/faces/11.jpg')}}" class="" alt="..."></span>
                                                            <div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            <span class="avatar avatar-xs avatar-rounded"><img src="{{asset('build/assets/images/faces/2.jpg')}}" class="" alt="..."></span>
                                                            <div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            <span class="avatar avatar-xs avatar-rounded"><img src="{{asset('build/assets/images/faces/4.jpg')}}" class="" alt="..."></span>
                                                            <div>
