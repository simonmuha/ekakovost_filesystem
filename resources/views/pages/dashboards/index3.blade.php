                                    ...
                                    <div class="d-flex align-items-end gap-2">
                                        <div class="offer-card-details">
                                            <div class="offer-item">
                                                <img src="{{asset('build/assets/images/media/media-90.png')}}" alt="Product Image" class="img-fluid offer-item-img">
                                                <div class="avatar avatar-xl mb-3">
                                                    <img src="{{asset('build/assets/images/ecommerce/png/17.png')}}" alt="Product Image" class="img-fluid">
                                                </div>
