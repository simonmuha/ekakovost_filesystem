                                                ...
                                                <div class="d-flex align-items-center gap-2 justify-content-between">
                                                    <div class="d-flex align-items-start gap-2">
                                                        <div class="lh-1 avatar avatar-sm p-1 bg-light avatar-rounded">
                                                            <img src="{{asset('build/assets/images/crypto-currencies/crypto-icons/bitcoin-btc-logo.svg')}}" alt="" class="w-auto">
                                                        </div>
                                                        <div>
                                        ...
                                        <div class="card custom-card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center gap-2 justify-content-between">
                                                    <div class="d-flex align-items-start gap-2">
                                                        <div class="lh-1 avatar avatar-sm p-1 bg-light avatar-rounded">
                                                            <img src="{{asset('build/assets/images/crypto-currencies/crypto-icons/binance-usd-busd-logo.svg')}}" alt="" class="w-auto">
                                                        </div>
                                                        <div>
                                        ...
                                        <div class="card custom-card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center gap-2 justify-content-between">
                                                    <div class="d-flex align-items-start gap-2">
                                                        <div class="lh-1 avatar avatar-sm p-1 bg-light avatar-rounded">
                                                            <img src="{{asset('build/assets/images/crypto-currencies/crypto-icons/cardano-ada-logo.svg')}}" alt="" class="w-auto">
                                                        </div>
                                                        <div>
                                        ...
                                        <div class="card custom-card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center gap-2 justify-content-between">
                                                    <div class="d-flex align-items-start gap-2">
                                                        <div class="lh-1 avatar avatar-sm p-1 bg-light avatar-rounded">
                                                            <img src="{{asset('build/assets/images/crypto-currencies/crypto-icons/ethereum-eth-logo.svg')}}" alt="" class="w-auto">
                                                        </div>
                                                        <div>
                                        ...
                                        <div class="card custom-card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center gap-2 justify-content-between">
                                                    <div class="d-flex align-items-start gap-2">
                                                        <div class="lh-1 avatar avatar-sm p-1 bg-light avatar-rounded">
                                                            <img src="{{asset('build/assets/images/crypto-currencies/crypto-icons/tether-usdt-logo.svg')}}" alt="" class="w-auto">
                                                        </div>
                                                        <div>
                                        ...
                                        <div class="card custom-card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center gap-2 justify-content-between">
                                                    <div class="d-flex align-items-start gap-2">
                                                        <div class="lh-1 avatar avatar-sm p-1 bg-light avatar-rounded">
                                                            <img src="{{asset('build/assets/images/crypto-currencies/crypto-icons/xrp-xrp-logo.svg')}}" alt="" class="w-auto xrp-logo">
                                                        </div>
                                                        <div>
                                        ...
                                        <div class="card custom-card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center gap-2 justify-content-between">
                                                    <div class="d-flex align-items-start gap-2">
                                                        <div class="lh-1 avatar avatar-sm p-1 bg-light avatar-rounded">
                                                            <img src="{{asset('build/assets/images/crypto-currencies/crypto-icons/solana-sol-logo.svg')}}" alt="" class="w-auto">
                                                        </div>
                                                        <div>
                                        ...
                                        <div class="me-3">
                                            <div class="btn-group ms-2">
                                                <button type="button" class="btn btn-primary border dropdown-toggle"
                                                    ...
                                                    <span class="avatar avatar-xs avatar-rounded me-2 align-middle"><img src="{{asset('build/assets/images/crypto-currencies/crypto-icons/bitcoin-btc-logo.svg')}}" alt=""></span>Bitcoin
                                                </button>
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item" href="javascript:void(0);"><span class="avatar avatar-xs avatar-rounded me-2 align-middle"><img src="{{asset('build/assets/images/crypto-currencies/crypto-icons/ethereum-eth-logo.svg')}}" alt=""></span>Etherium</a></li>
                                                    <li><a class="dropdown-item" href="javascript:void(0);"><span class="avatar avatar-xs avatar-rounded me-2 align-middle"><img src="{{asset('build/assets/images/crypto-currencies/crypto-icons/tether-usdt-logo.svg')}}" alt=""></span>Tether</a></li>
                                                    <li><a class="dropdown-item" href="javascript:void(0);"><span class="avatar avatar-xs avatar-rounded me-2 align-middle"><img src="{{asset('build/assets/images/crypto-currencies/crypto-icons/xrp-xrp-logo.svg')}}" alt=""></span>XRP</a></li>
                                                    <li><a class="dropdown-item" href="javascript:void(0);"><span class="avatar avatar-xs avatar-rounded me-2 align-middle"><img src="{{asset('build/assets/images/crypto-currencies/crypto-icons/tron-trx-logo.svg')}}" alt=""></span>TRON</a></li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class=" mt-2 pt-1 d-flex gap-1">
                                        <button type="button" class="btn btn-primary1-light flex-fill">History<i class="ms-2 ti ti-arrow-narrow-right align-middle"></i></button>
                                        <button type="button" class="btn btn-primary flex-fill">Convert<i class="ms-2 ti ti-arrow-narrow-right align-middle"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('scripts')
        ...
        <!-- Crypto Dashboard --> 
        <script src="{{asset('build/assets/crypto-dashboard.js')}}"></script>
