                                    ...
                                    <div class="row list-wrapper">
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-md-6 card-item icecream" data-category="icecream">
                                            <div class="card custom-card p-3 out-of-stock">
                                                <img src="{{asset('build/assets/images/pos-system/18.jpg')}}" class="card-img-top" alt="...">
                                                <div class="card-body bg-secondary-transparent rounded-bottom">
                                                    <div class="mb-3">
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-md-6 card-item coffee" data-category="coffee">
                                            <div class="card custom-card p-3">
                                                <img src="{{asset('build/assets/images/pos-system/17.jpg')}}" class="card-img-top" alt="...">
                                                <div class="card-body bg-secondary-transparent rounded-bottom">
                                                    <div class="mb-3">
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-md-6 card-item cupcakes" data-category="cupcakes">
                                            <div class="card custom-card p-3">
                                                <img src="{{asset('build/assets/images/pos-system/11.jpg')}}" class="card-img-top" alt="...">
                                                <div class="card-body bg-secondary-transparent rounded-bottom">
                                                    <div class="mb-3">
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-md-6 card-item cupcakes" data-category="cupcakes">
                                            <div class="card custom-card p-3">
                                                <img src="{{asset('build/assets/images/pos-system/12.jpg')}}" class="card-img-top" alt="...">
                                                <div class="card-body bg-secondary-transparent rounded-bottom">
                                                    <div class="mb-3">
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-md-6 card-item pizza" data-category="pizza">
                                            <div class="card custom-card p-3">
                                                <img src="{{asset('build/assets/images/pos-system/16.jpg')}}" class="card-img-top" alt="...">
                                                <div class="card-body bg-secondary-transparent rounded-bottom">
                                                    <div class="mb-3">
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-md-6 card-item coffee" data-category="coffee">
                                            <div class="card custom-card p-3">
                                                <img src="{{asset('build/assets/images/pos-system/14.jpg')}}" class="card-img-top" alt="...">
                                                <div class="card-body bg-secondary-transparent rounded-bottom">
                                                    <div class="mb-3">
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-md-6 card-item burger" data-category="burger">
                                            <div class="card custom-card p-3">
                                                <img src="{{asset('build/assets/images/pos-system/15.jpg')}}" class="card-img-top" alt="...">
                                                <div class="card-body bg-secondary-transparent rounded-bottom">
                                                    <div class="mb-3">
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-md-6 card-item waffle" data-category="waffle">
                                            <div class="card custom-card p-3">
                                                <img src="{{asset('build/assets/images/pos-system/19.jpg')}}" class="card-img-top" alt="...">
                                                <div class="card-body bg-secondary-transparent rounded-bottom">
                                                    <div class="mb-3">
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-md-6 card-item pizza" data-category="pizza">
                                            <div class="card custom-card p-3">
                                                <img src="{{asset('build/assets/images/pos-system/10.jpg')}}" class="card-img-top" alt="...">
                                                <div class="card-body bg-secondary-transparent rounded-bottom">
                                                    <div class="mb-3">
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-md-6 card-item coffee" data-category="coffee">
                                            <div class="card custom-card p-3">
                                                <img src="{{asset('build/assets/images/pos-system/13.jpg')}}" class="card-img-top" alt="...">
                                                <div class="card-body bg-secondary-transparent rounded-bottom">
                                                    <div class="mb-3">
                        ...
                        <div class="offcanvas-body p-0">
                            ...
                            <div class="p-3">
                                ...
                                <div class="d-flex gap-3 mt-4">
                                    ...
                                    <a href="{{url('checkout')}}" class="btn btn-primary btn-wave flex-fill waves-effect waves-light">Pay Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
