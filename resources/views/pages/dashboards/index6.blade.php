                                ...
                                <div class="card-body p-4">
                                    <div class="row align-items-center mx-0">
                                        ...
                                        <div class="col-xl-5 text-end">
                                            <img src="{{asset('build/assets/images/nft-images/1.jpg')}}" class="img-fluid nft-main-banner-image shadow p-3 me-2" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div class="me-2 lh-1">
                                                        <div class="avatar-list-stacked">
                                                            <span class="avatar avatar-sm bg-primary1-transparent border border-primary1 border-opacity-10 avatar-rounded">
                                                                <img src="{{asset('build/assets/images/nft-images/3.jpg')}}" alt="" class="p-1 rounded-circle">
                                                            </span>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="me-2 lh-1">
                                                        <span class="avatar avatar-sm bg-primary3-transparent border border-primary1 border-opacity-10 avatar-rounded">
                                                            <img src="{{asset('build/assets/images/nft-images/11.jpg')}}" alt="" class="p-1 rounded-circle">
                                                        </span>
                                                    </div>
                                                    <a href="javascript:void(0);" class="btn btn-primary-light btn-sm "><i class="ri-add-line align-middle me-1"></i>Follow</a>
                                                </div>
                                            ...
                                            <div class="ms-auto my-auto">
                                                <div class="d-flex align-items-center">
                                                    <div class="me-2 lh-1">
                                                        <div class="avatar-list-stacked">
                                                            <span class="avatar avatar-sm bg-primary1-transparent border border-primary1 border-opacity-10 avatar-rounded">
                                                                <img src="{{asset('build/assets/images/nft-images/5.jpg')}}" alt="" class="p-1 rounded-circle">
                                                            </span>
                                        ...
                                        <li class="list-group-item d-flex gap-1">
                                            ...
                                            <div class="ms-auto my-auto">
                                                <div class="d-flex align-items-center">
                                                    <div class="me-2 lh-1">
                                                        <span class="avatar avatar-sm bg-primary1-transparent border border-primary1 border-opacity-10 avatar-rounded">
                                                            <img src="{{asset('build/assets/images/nft-images/8.jpg')}}" alt="" class="p-1 rounded-circle">
                                                        </span>
                                                    </div>
                                                    <a href="javascript:void(0);" class="btn btn-primary-light btn-sm "><i class="ri-add-line align-middle me-1"></i>Follow</a>
                                                </div>
                                        ...
                                        <li class="list-group-item d-flex gap-1">
                                            ...
                                            <div class="ms-auto my-auto">
                                                <div class="d-flex align-items-center">
                                                        <div class="me-2 lh-1">
                                                            <span class="avatar avatar-sm bg-primary1-transparent border border-primary1 border-opacity-10 avatar-rounded">
                                                                <img src="{{asset('build/assets/images/nft-images/4.jpg')}}" alt="" class="p-1 rounded-circle">
                                                            </span>
                                                        </div>
                                                        <a href="javascript:void(0);" class="btn btn-primary-light btn-sm "><i class="ri-add-line align-middle me-1"></i>Follow</a>
                                                    </div>
                                            ...
                                            <a href="javascript:void(0);">
                                                <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <p class="fw-medium mb-0">Meesthi Si</p>
                                                            <span class="text-muted fs-12 d-inline-flex">@meesthi03<span class="text-primary lh-1 fs-16 ms-1 d-inline-flex"><i class="ti ti-discount-check-filled "></i></span>
                                                        </div>
                                                    </div>
                                                    <div class="text-end">
                                                ...
                                                <div class="d-flex flex-wrap align-items-center justify-content-between flex-xl-nowrap">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <span class="text-muted fs-12 d-inline-flex">@tomarko98<span class="text-primary lh-1 fs-16 ms-1 d-inline-flex"><i class="ti ti-discount-check-filled "></i></span>
                                                        </div>
                                                    </div>
                                                    <div class="text-end">
                                                        <span class="fs-12 text-muted">99.9k Bidders</span>
                                                ...
                                                <div class="d-flex flex-wrap align-items-center justify-content-between flex-xl-nowrap">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <span class="text-muted fs-12 d-inline-flex">@kazimo900<span class="text-primary lh-1 fs-16 ms-1 d-inline-flex"><i class="ti ti-discount-check-filled "></i></span>
                                                        </div>
                                                    </div>
                                                    <div class="text-end">
                                                        <span class="fs-12 text-muted">99.9k Bidders</span>
                                            ...
                                            <a href="javascript:void(0);">
                                                <div class="d-flex flex-wrap align-items-center justify-content-between flex-xl-nowrap">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <p class="fw-medium mb-0">Oorichimaru lo</p>
                                                            <span class="text-muted fs-12 d-inline-flex">@ooro001<span class="text-primary lh-1 fs-16 ms-1 d-inline-flex"><i class="ti ti-discount-check-filled "></i></span>
                                                        </div>
                                                    </div>
                                                    <div class="text-end">
                                                        <span class="fs-12 text-muted">99.9k Bidders</span>
                                            ...
                                            <a href="javascript:void(0);">
                                                <div class="d-flex flex-wrap align-items-center justify-content-between flex-xl-nowrap">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <p class="fw-medium mb-0">Sasuke Uchiha</p>
                                                            <span class="text-muted fs-12 d-inline-flex">@sasuke777<span class="text-primary lh-1 fs-16 ms-1 d-inline-flex"><i class="ti ti-discount-check-filled "></i></span>
                                                        </div>
                                                    </div>
                                                    <div class="text-end">
                                                        <span class="fs-12 text-muted">99.9k Bidders</span>
                                                ...
                                                <div class="d-flex flex-wrap align-items-center justify-content-between flex-xl-nowrap">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <span class="text-muted fs-12 d-inline-flex">@nagiro096<span class="text-primary lh-1 fs-16 ms-1 d-inline-flex"><i class="ti ti-discount-check-filled "></i></span>
                                                        </div>
                                                    </div>
                                                    <div class="text-end">
                                                        <span class="fs-12 text-muted">99.9k Bidders</span>
