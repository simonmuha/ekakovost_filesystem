                                ...
                                <div class="card-body p-4">
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="col-xxl-4 col-xl-7 col-lg-7 col-md-7 col-sm-7 d-sm-block d-none text-end my-auto">
                                            <img src="{{asset('build/assets/images/media/media-91.png')}}" alt="" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <ul class="list-unstyled mb-0 analytics-visitors-countries">
                                        ...
                                        <li class="mb-4">
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-xs avatar-rounded text-default">
                                                        <img src="{{asset('build/assets/images/flags/china_flag.jpg')}}" alt="">
                                                    </span>
                                                </div>
                                                <div class="ms-1 flex-fill lh-1">
                                        ...
                                        <li class="mb-4">
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-xs avatar-rounded text-default">
                                                        <img src="{{asset('build/assets/images/flags/singapore_flag.jpg')}}" alt="">
                                                    </span>
                                                </div>
                                                <div class="ms-1 flex-fill lh-1">
