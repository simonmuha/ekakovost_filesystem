                                    ...
                                    <ul class="d-flex flex-column list-unstyled mb-0 popular-course">
                                            ...
                                            <div class="d-sm-flex align-items-start w-100">
                                                ...
                                                <div class="flex-grow-1 fw-medium">
                                                    <div class="d-flex align-items-center" title="Instructor">
                                                        ...
                                                        <img src="{{asset('build/assets/images/faces/1.jpg')}}" alt="img" class="avatar avatar-xs rounded-pill">
                                                        </a>
                                        ...
                                        <li class=" text-muted mb-3">
                                            <div class="d-sm-flex align-items-start w-100">
                                                ...
                                                <div class="flex-grow-1 fw-medium">
                                                    <div class="d-flex align-items-center" title="Instructor">
                                                        <a href="javascript:void(0);" class="pe-2">
                                                        <img src="{{asset('build/assets/images/faces/6.jpg')}}" alt="img" class="avatar avatar-xs rounded-pill">
                                                        </a>
                                        ...
                                        <div class="d-sm-flex align-items-start w-100">
                                            ...
                                            <div class="flex-grow-1 fw-medium">
                                                <div class="d-flex align-items-center" title="Instructor">
                                                    <a href="javascript:void(0);" class="pe-2">
                                                    <img src="{{asset('build/assets/images/faces/11.jpg')}}" alt="img" class="avatar avatar-xs rounded-pill">
                                                    </a>
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card custom-card mb-0 border shadow-none">
                                                    <div class="card-body p-0">
                                                        <div class="">
                                                            <img src="{{asset('build/assets/images/media/media-76.png')}}" alt="" class="img-fluid card-img-top bg-secondary-transparent">
                                                            <div class="p-3">
                                                                <div class="min-w-fit fs-11 text-default d-inline-flex">
                                                                    <span>
                                                                        <i class="ri-star-fill text-warning"></i> 4.2</span>
