                        ...
                        <div class="col-xl-9">
                            <div class="card custom-card">
                                <ul class="nav nav-tabs tab-style-8 scaleX rounded m-3 profile-settings-tab gap-2" id="myTab4" role="tablist">
                                    ...
                                    <li class="nav-item me-1" role="presentation">
                                        <button class="nav-link  px-4 bg-primary-transparent" id="notification-tab" data-bs-toggle="tab" data-bs-target="#notification-tab-pane" type="button" role="tab" aria-controls="notification-tab-pane" aria-selected="false">Notification</button>
                                    </li>
                                    ...
                                    <div class="tab-pane show active overflow-hidden p-0 border-0" id="account-pane" role="tabpanel" aria-labelledby="account" tabindex="0">
                                        ...
                                        <div class="row gy-3">
                                                ...
                                                <div class="d-flex align-items-start flex-wrap gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="btn-list mb-1">
                                                            ...
                                                            <button class="btn btn-sm btn-primary1-light btn-wave"><i class="ri-delete-bin-line me-1"></i>Remove</button>
                                                        </div>
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <input type="text" class="form-control bg-light" id="website" placeholder="https://" value="https://www.website.com">
                                            </div>
                                            <div class="col-xl-12">
