                                    ...
                                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                                        ...
                                        <div class="carousel-inner rounded-0">
                                            <div class="carousel-item active">
                                                <img src="{{asset('build/assets/images/media/blog/1.jpg')}}" class="d-block w-100" alt="...">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="{{asset('build/assets/images/media/blog/3.jpg')}}" class="d-block w-100" alt="...">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="{{asset('build/assets/images/media/blog/2.jpg')}}" class="d-block w-100" alt="...">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="p-3">
                                        <h5 class="fw-semibold"><a href="{{url('blog-details')}}">Melodic Mastery: A Deep Dive into Music Notes</a></h5>
                                    ...
                                    <div class="card custom-card">
                                        <div class="row g-0">
                                            ...
                                            <div class="col-xxl-4 col-md-2 col-sm-2">
                                                <img src="{{asset('build/assets/images/media/blog/4.jpg')}}" class="img-fluid rounded-end h-100 w-100" alt="...">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card custom-card">
                                        <div class="row g-0 justify-content-center">
                                            ...
                                            <div class="col-sm-12 text-center">
                                                <div class="card-body pt-1">
                                                    <img src="{{asset('build/assets/images/media/blog/9.jpg')}}" class="img-fluid rounded w-100" alt="...">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
