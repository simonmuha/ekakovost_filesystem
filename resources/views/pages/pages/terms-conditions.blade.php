                            ...
                            <div class="card custom-card overflow-hidden">
                                <div class="card-body p-4">
                                    <div class="mb-3 text-center">
                                        <h3 class="mb-1 text-primary">Terms and Conditions</h3>
                                        <div><span class="fw-semibold">Last Updated: </span>5 days ago</div> 
                                        <div><span class="fw-semibold">Effective Date:</span> 5 weeks from the present date</div>
                                    </div>
                                    <h6 class="fw-medium mb-3 text-primary">Agreement</h6>
                                    <ul class="terms-list list-unstyled">
                                        <li>
                                            <div class="fs-14 fw-medium">1. Agreement :</div>
                                            <p class="mb-0">
                                        ...
                                        <li>
                                            <div class="fs-14 fw-medium">2. License :</div>
                                            <p class="mb-0">
                                        ...
                                        <li>
                                            <div class="fs-14 fw-medium">3. Ownership :</div>
                                            <p class="mb-0">
                                    ...
                                    <h6 class="fw-medium mb-3 text-primary">Privacy Policy</h6>
                                    <ul class="terms-list list-unstyled mb-3">
                                        <li>
                                            <div class="fs-14 fw-medium">1. Information Collection :</div>
                                            <ul class="mb-1">
                                        ...
                                        <li>
                                            <div class="fs-14 fw-medium">2.Information Usage :</div>
                                            <ul class="mb-1">
                                        ...
                                        <li>
                                            <div class="fs-14 fw-medium">3. Data Security :</div>
                                            <ul class="mb-1">
                                        ...
                                        <li>
                                            <div class="fs-14 fw-medium">4. Third-party Links:</div>
                                            <ul class="mb-1">
                                        ...
                                        <li>
                                            <div class="fs-14 fw-medium">5. Policy Updates:</div>
                                            <ul class="mb-1">
                                    ...
                                    <h6 class="fw-medium mb-3 text-primary">Termination</h6>
                                    <ul class="terms-list list-unstyled mb-3">
                                        <li>
                                            <div class="fs-14 fw-medium">1. Termination by User :</div>
                                            <ul class="mb-1">
                                        ...
                                        <li>
                                            <div class="fs-14 fw-medium">2.Termination by Provider :</div>
                                            <ul class="mb-1">
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" value="" id="acceptance1">
                                        <label class="form-check-label text-muted fw-normal" for="acceptance1">
                                            I agree with the <span class="text-default fw-medium">Terms and Conditions</span>
                                        </label>
                                    </div>
                                    <div class="form-check mb-0">
                                        <input class="form-check-input" type="checkbox" value="" id="acceptance2">
                                        <label class="form-check-label text-muted fw-normal" for="acceptance2">
                                            I agree with the<span class="text-default fw-medium"> Privacy Policy</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <div class="text-end">
                                        <div class="btn btn-lg btn-primary1-light me-2">
                                            Decline
                                        </div>
