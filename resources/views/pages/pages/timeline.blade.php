                            ...
                            <div class="card custom-card">
                                ...
                                <ul class="notification container px-3">
                                    <li>
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="notification-body border border-primary border-opacity-50">
                                                    <div class="d-flex align-items-start gap-3 flex-wrap">
                                                        ...
                                                        <div class="flex-fill w-50">
                                                            <h5 class="mb-1 fs-15 fw-medium text-dark">Event Conceptualization </h5>
                                                            <p class="mb-0 mb-0 text-muted">Brainstormed event ideas and themes.Conducted initial research on venue options and potential sponsors</p>
                                                        </div>
                                                        <div>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="notification-time d-flex align-items-center gap-2">
                                    ...
                                    <li>
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="notification-time d-flex align-items-center gap-2 content-end">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="notification-body notification-body-end border border-primary1 border-opacity-50">
                                                    <div class="d-flex align-items-start gap-3 flex-wrap">
                                                        <div>
                                                            <span class="avatar avatar-lg online">
                                                        ...
                                                        <div class="flex-fill w-50">
                                                            <h5 class="mb-1 fs-15 fw-medium text-dark">Preparation and Organization</h5>
                                                            <p class="mb-0 fs-13 mb-0 text-muted">Secured venue and finalized contracts with vendors.Created event marketing materials and promotional strategies.Established event logistics.</p>
                                                        </div>
                                                        <div>
                                    ...
                                    <li>
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="notification-body border border-primary2 border-opacity-50">
                                                    <div class="d-flex align-items-start gap-3 flex-wrap">
                                                        <div>
                                                            <span class="avatar avatar-lg online">
                                                        ...
                                                        <div class="flex-fill w-50">
                                                            <h5 class="mb-1 fs-15 fw-medium text-dark">Event Execution </h5>
                                                            <p class="mb-0 fs-13 mb-0 text-muted">Set up event space and coordinated with vendors for equipment and services.Facilitated event activities, speakers, and entertainment.</p>
                                                        </div>
                                                        <div>
                                                            <span class="badge bg-primary2-transparent">
                                                                May 20, 2024
                                                            </span>
                                                        </div>
                                                    </div>
                                    ...
                                    <li>
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="notification-body notification-body-end border border-primary3 border-opacity-50">
                                                    <div class="d-flex align-items-start gap-3 flex-wrap">
                                                        <div>
                                                            <span class="avatar avatar-lg online">
                                                        ...
                                                        <div class="flex-fill w-50">
                                                            <h5 class="mb-1 fs-15 fw-medium text-dark">Product Development</h5>
                                                            <p class="mb-0 fs-13 mb-0 text-muted">Conducted market research and identified customer needs.Defined product specifications and features.</p>
                                                        </div>
                                                        <div>
                                                            <span class="badge bg-primary3-transparent">
                                                                May 1 - May 15, 2024
                                                            </span>
                                                        </div>
                                                    </div>
                                    ...
                                    <li>
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="notification-body border border-secondary border-opacity-50">
                                                    <div class="d-flex align-items-start gap-3 flex-wrap">
                                                        <div>
                                                            <span class="avatar avatar-lg online">
                                                        ...
                                                        <div class="flex-fill w-50">
                                                            ...
                                                            <p class="mb-0 fs-13 mb-0 text-muted">Our team took a break to recharge and bond. We came back stronger!</p>
                                                        </div>
                                                        <div>
                                    ...
                                    <li>
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="notification-body notification-body-end border border-warning border-opacity-50">
                                                    <div class="d-flex align-items-start gap-3 flex-wrap">
                                                        <div>
                                                            <span class="avatar avatar-lg online">
                                                        ...
                                                        <div class="flex-fill w-50">
                                                            <h5 class="mb-1 fs-15 fw-medium text-dark">Design and Development </h5>
                                                            <p class="mb-0 fs-13 mb-0 text-muted">Designed user interface (UI) and user experience (UX) elements.Developed product functionalities.</p>
                                                        </div>
                                                        <div>
                                    ...
                                    <li>
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="notification-body border border-info border-opacity-50">
                                                    <div class="d-flex align-items-start gap-3 flex-wrap">
                                                        <div>
                                                            <span class="avatar avatar-lg online">
                                                        ...
                                                        <div class="flex-fill w-50">
                                                            <h5 class="mb-1 fs-15 fw-medium text-dark">Testing and Launch </h5>
                                                            <p class="mb-0 fs-13 mb-0 text-muted">Conducted comprehensive testing to ensure product quality and stability.Prepared marketing materials.</p>
                                                        </div>
                                                        <div>
                    ...
                    <div class="row justify-content-center timeline-3">
                        <div class="col-xxl-11">
                            <div class="card custom-card">
                                ...
                                <div class="card-body pt-xxl-5 mt-xxl-5">
                                    <div class="timeline-steps">
                                        <div class="timeline-step">
                                            <div class="timeline-content" data-toggle="popover" data-placement="top" title="" data-content="And here's some amazing content. It's very engaging. Right?" data-original-title="2003">
                                                ...
                                                <div class="card custom-card mb-0 border border-opacity-25 border-primary1 bg-primary1-transparent">
                                                    <div class="card-body">
                                                        <span class="avatar avatar-sm avatar-rounded">
                                                            <img src="{{asset('build/assets/images/faces/11.jpg')}}" alt="">
                                                        </span>
                                                        <p class="fw-medium mt-1 mb-1"> October 6, 2024</p>
                                                        <p class="mb-1 fw-semibold">Planning: <span class="text-muted fw-normal mb-0 mb-lg-0">Research and competitor analysis.</span>  </p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="timeline-step">
                                            <div class="timeline-content" data-toggle="popover" data-placement="top" title="" data-content="And here's some amazing content. It's very engaging. Right?" data-original-title="2004">
                                                <div class="inner-circle"></div>
                                                <div class="card custom-card mb-0 border border-opacity-25 border-primary2 bg-primary2-transparent content-top">
                                                    <div class="card-body">
                                                        <span class="avatar avatar-sm avatar-rounded">
                                                            <img src="{{asset('build/assets/images/faces/1.jpg')}}" alt="">
                                                        </span>
                                                        <p class="fw-medium mt-1 mb-1">September 12, 2024</p>
                                                        <p class="mb-1 fw-semibold">Design: <span class="text-muted fw-normal mb-0 mb-lg-0">Frontend and backend components.</span> </p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="timeline-step">
                                            <div class="timeline-content" data-toggle="popover" data-placement="top" title="" data-content="And here's some amazing content. It's very engaging. Right?" data-original-title="2005">
                                                <div class="inner-circle"></div>
                                                <div class="card custom-card mb-0 border border-opacity-25 border-primary3 bg-primary3-transparent">
                                                    <div class="card-body">
                                                        <span class="avatar avatar-sm avatar-rounded">
                                                            <img src="{{asset('build/assets/images/faces/12.jpg')}}" alt="">
                                                        </span>
                                                        <p class="fw-medium mt-1 mb-1">July 20, 2024</p>
                                                        <p class="mb-1 fw-semibold">Testing: <span class="text-muted fw-normal mb-0 mb-lg-0">Conducted comprehensive testing.</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="timeline-step">
                                            <div class="timeline-content" data-toggle="popover" data-placement="top" title="" data-content="And here's some amazing content. It's very engaging. Right?" data-original-title="2010">
                                                <div class="inner-circle"></div>
                                                <div class="card custom-card mb-0 border border-opacity-25 border-secondary bg-secondary-transparent content-top">
                                                    <div class="card-body">
                                                        <span class="avatar avatar-sm avatar-rounded">
                                                            <img src="{{asset('build/assets/images/faces/3.jpg')}}" alt="">
                                                        </span>
                                                        <p class="fw-medium mt-1 mb-1">May 18, 2024</p>
                                                        <p class="mb-1 fw-semibold">Deployment: <span class="text-muted fw-normal mb-0 mb-lg-0">Conducted final checks.</span></p> 
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="timeline-step mb-0">
                                            <div class="timeline-content" data-toggle="popover" data-placement="top" title="" data-content="And here's some amazing content. It's very engaging. Right?" data-original-title="2020">
                                                <div class="inner-circle"></div>
                                                <div class="card custom-card mb-0 border border-opacity-25 border-warning bg-warning-transparent">
                                                    <div class="card-body">
                                                        <span class="avatar avatar-sm avatar-rounded">
                                                            <img src="{{asset('build/assets/images/faces/14.jpg')}}" alt="">
                                                        </span>
                                                        <p class="fw-medium mt-1 mb-1"> April 5, 2024</p>
                                                        <p class="mb-1 fw-semibold">Post-Launch: <span class="text-muted fw-normal mb-0 mb-lg-0">Provided ongoing support.</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
