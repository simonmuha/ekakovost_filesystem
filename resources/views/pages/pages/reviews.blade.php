                                            ...
                                            <div class="swiper-slide">
                                                <div class="card custom-card overflow-hidden">
                                                    <div class="p-3 text-center align-items-center justify-content-start gap-2 border-bottom border-block-end-dashed bg-secondary-transparent">
                                                        <img src="{{asset('build/assets/images/faces/1.jpg')}}" alt="img" class="mb-2 mx-auto text-center avatar avatar-xl rounded-circle shadow-sm">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card custom-card overflow-hidden">
                                                    <div
                                                        ...
                                                        <img src="{{asset('build/assets/images/faces/6.jpg')}}" alt="img" class="mb-2 mx-auto text-center avatar avatar-xl rounded-circle shadow-sm">
                                                        <div class="flex-grow-1">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card custom-card overflow-hidden">
                                                    <div
                                                        ...
                                                        <img src="{{asset('build/assets/images/faces/13.jpg')}}" alt="img" class="mb-2 mx-auto text-center avatar avatar-xl rounded-circle shadow-sm">
                                                        <div class="flex-grow-1">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card custom-card overflow-hidden">
                                                    <div
                                                        ...
                                                        <img src="{{asset('build/assets/images/faces/10.jpg')}}" alt="img" class="mb-2 mx-auto text-center avatar avatar-xl rounded-circle shadow-sm">
                                                        <div class="flex-grow-1">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card custom-card overflow-hidden">
                                                    <div
                                                        ...
                                                        <img src="{{asset('build/assets/images/faces/15.jpg')}}" alt="img" class="mb-2 mx-auto text-center avatar avatar-xl rounded-circle shadow-sm">
                                                        <div class="flex-grow-1">
                                                ...
                                                <div class="card-footer">
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar rounded-circle me-2">
                                                            <img src="{{asset('build/assets/images/faces/8.jpg')}}" alt="" class="img-fluid rounded-circle border border-primary border-2">
                                                        </span>
                                                        <div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card custom-card border mb-0">
                                                ...
                                                <div class="card-footer">
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar rounded-circle me-2">
                                                            <img src="{{asset('build/assets/images/faces/9.jpg')}}" alt="" class="img-fluid rounded-circle border border-primary border-2">
                                                        </span>
                                                        <div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card custom-card border mb-0">
                                                ...
                                                <div class="card-footer">
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar rounded-circle me-2">
                                                            <img src="{{asset('build/assets/images/faces/6.jpg')}}" alt="" class="img-fluid rounded-circle border border-primary border-2">
                                                        </span>
                                                        <div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card custom-card border mb-0">
                                                ...
                                                <div class="card-footer">
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar rounded-circle me-2">
                                                            <img src="{{asset('build/assets/images/faces/14.jpg')}}" alt="" class="img-fluid rounded-circle border border-primary border-2">
                                                        </span>
                                                        <div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card custom-card border mb-0">
                                                ...
                                                <div class="card-footer">
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar rounded-circle me-2">
                                                            <img src="{{asset('build/assets/images/faces/13.jpg')}}" alt="" class="img-fluid rounded-circle border border-primary border-2">
                                                        </span>
                                                        <div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card custom-card border mb-0">
                                                ...
                                                <div class="card-footer">
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar rounded-circle me-2">
                                                            <img src="{{asset('build/assets/images/faces/11.jpg')}}" alt="" class="img-fluid rounded-circle border border-primary border-2">
                                                        </span>
                                                        <div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="card custom-card border position-relative">
                                            <div class="card-body text-center">
                                                    <div>
                                                        <img src="{{asset('build/assets/images/faces/1.jpg')}}" alt="img" class="mx-auto text-center avatar avatar-xl rounded-circle border-3 border border-white-1 mb-2 bg-primary">
                                                    </div>
                                                    <div class="">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card custom-card border position-relative">
                                            <div class="card-body text-center">
                                                    <div>
                                                        <img src="{{asset('build/assets/images/faces/12.jpg')}}" alt="img" class="mx-auto text-center avatar avatar-xl rounded-circle border-3 border border-white-1 mb-2 bg-primary">
                                                    </div>
                                                    <div class="">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card custom-card border position-relative">
                                            <div class="card-body text-center">
                                                    <div>
                                                        <img src="{{asset('build/assets/images/faces/3.jpg')}}" alt="img" class="mx-auto text-center avatar avatar-xl rounded-circle border-3 border border-white-1 mb-2 bg-primary">
                                                    </div>
                                                    <div class="">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card custom-card border position-relative">
                                            <div class="card-body text-center">
                                                    <div>
                                                        <img src="{{asset('build/assets/images/faces/14.jpg')}}" alt="img" class="mx-auto text-center avatar avatar-xl rounded-circle border-3 border border-white-1 mb-2 bg-primary">
                                                    </div>
                                                    <div class="">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card custom-card border position-relative">
                                            <div class="card-body text-center">
                                                    <div>
                                                        <img src="{{asset('build/assets/images/faces/5.jpg')}}" alt="img" class="mx-auto text-center avatar avatar-xl rounded-circle border-3 border border-white-1 mb-2 bg-primary">
                                                    </div>
                                                    <div class="">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card custom-card border position-relative">
                                            <div class="card-body text-center">
                                                    <div>
                                                        <img src="{{asset('build/assets/images/faces/6.jpg')}}" alt="img" class="mx-auto text-center avatar avatar-xl rounded-circle border-3 border border-white-1 mb-2 bg-primary">
                                                    </div>
                                                    <div class="">
