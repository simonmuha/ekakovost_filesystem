                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card profile-card">
                                <div class="profile-banner-img">
                                    <img src="/storage/app/organizations/people/{{$person->person_home_image}}" class="card-img-top" alt="...">
                                </div>
                                                ...
                                                <div class="card-body border-bottom border-block-end-dashed">
                                                    <div class="text-center">
                                                        <span class="avatar avatar-xxl avatar-rounded online mb-3">
                                                            <img src="/storage/users/{{$user->user_profile_image}}" alt="">
                                                        </span>
                                                        <h5 class="fw-semibold mb-1">{{$person->person_name}} {{$person->person_surname}}</h5>
                                                        <span class="d-block fw-medium text-muted mb-2">
                                                            @foreach($person->positions as $position)
                                                                {{ $position->app_position_name }}
                                                            @endforeach
                                                        </span>
                                                ...
                                                <div class="card-body border-bottom border-block-end-dashed p-0">
                                                    <ul class="list-group list-group-flush">
                                                        <li class="list-group-item pt-2 border-0">
                                                            <div><span class="fw-medium me-2">Ime:</span><span class="text-muted">{{ $user->name }}</span></div>
                                                        </li>
                                                        <li class="list-group-item pt-2 border-0">
                                                            <div><span class="fw-medium me-2">E-naslov:</span><span class="text-muted">{{ $user->email }}</span></div>
                                                        </li>
                                                    </ul>
                                                </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    @foreach($user->people as $user_person)
                                                        <li class="nav-item" role="presentation">
                                                            <button 
                                                                class="nav-link w-100 text-start {{ $loop->first ? 'active' : '' }}" 
                                                                id="profile-about-tab-{{ $user_person->organization->id }}" 
                                                                data-bs-toggle="tab"
                                                                data-bs-target="#profile-about-tab-{{ $user_person->organization->id }}-pane" 
                                                                type="button" 
                                                                role="tab"
                                                                aria-controls="profile-about-tab-{{ $user_person->organization->id }}-pane" 
                                                                aria-selected="{{ $loop->first ? 'true' : 'false' }}">
                                                                <i class="ri-building-line me-1 align-middle"></i>
                                                                {{ $user_person->organization->app_organization_name_short }}
                                                            </button>
                                                        </li>
                                                    @endforeach
                                                    ...
                                                    <div class="tab-content" id="profile-tabs">
                                                        @foreach($user->people as $user_person)
                                                            <div 
                                                                ...
                                                                id="profile-about-tab-{{ $user_person->organization->id }}-pane" 
                                                                role="tabpanel" 
                                                                aria-labelledby="profile-about-tab-{{ $user_person->organization->id }}" 
                                                                tabindex="0">
                                                                <ul class="list-group list-group-flush border rounded-3">
                                                                    <p class="text-muted mb-2">
                                                                        <img style="width: 100%" src="/storage/app/organizations/people/{{$user_person->person_home_image}}" alt="Naslovna slika">
                                                                    </p>
                                                                    <li class="list-group-item p-3">
                                                                        <span class="fw-medium fs-15 d-block mb-3"><span class="me-1">&#10024;</span>
                                                                            Osnovni podatki:
                                                                        </span>
                                                                        <p class="text-muted mb-2">
                                                                            <div><span class="fw-medium me-2">Ime:</span><span class="text-muted">{{ $user_person->person_name }}</span></div>
                                                                            <div><span class="fw-medium me-2">Priimek:</span><span class="text-muted">{{ $user_person->person_surname }}</span></div>
                                                                        </p>
                                                                    </li>
                                                                    <li class="list-group-item p-3">
                                                                        <span class="fw-medium fs-15 d-block mb-3"><span class="me-1">&#10024;</span>
                                                                        ...
                                                                        <p class="text-muted mb-2">
                                                                            @if ($user_person->person_description != null)
                                                                                {!!$user_person->person_description!!}
                                                                            @else
