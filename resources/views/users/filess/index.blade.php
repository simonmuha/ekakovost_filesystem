                        ...
                        <div>
                            <nav>
                                <ol class="breadcrumb mb-1">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">{{ $person->person_name }} {{ $person->person_surname }}</a></li>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="d-flex align-items-center gap-3 p-3 border-bottom border-block-end-dashed">
                                            ...
                                            <div class="main-profile-info">
                                                <h6 class="fw-semibold mb-1">{{ $person->person_name }} {{ $person->person_surname }} </h6>
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    <div class="filemanager-upgrade-storage w-100 text-center"> 
                                        <span class="d-block mb-3 pb-1 bg-primary1-transparent rounded-2"> <img src="{{asset('build/assets/images/media/file-manager/2.png')}}" alt=""> </span>
