...
class SchoolOrganizationYearsController extends Controller
{
    ...
    public function index()
    {
        ...
        $school_organization_years = $school_organization->organization_years;
        $school_years = SchoolYear::all();
        //return($school_organization_years);
        //return ($app_positions);
        return view('school_admin.school.years.index')
            ->with('school_years', $school_years)
            ->with('school_organization', $school_organization)
            ->with('school_organization_years', $school_organization_years);
    }
